package com.hurlant.crypto.prng
{
   ...
   public class Random
   {
      ...
      public function Random(param1:Class = null)
      {
         ...
         this.var_106 = 0;
         while(this.var_106 < this.psize)
         {
            _loc2_ = uint(65536 * Math.random());
            var _loc3_:* = this.var_106++;
            this.var_146[_loc3_] = _loc2_ >>> 8;
            var _loc4_:*;
            this.var_146[_loc4_ = this.var_106++] = _loc2_ & 255;
         }
         this.var_106 = 0;
         this.seed();
      }
      ...
      public function seed(param1:int = 0) : void
      {
         ...
         var _loc2_:* = this.var_106++;
         this.var_146[_loc2_] ^= param1 & 255;
         var _loc3_:* = this.var_106++;
         this.var_146[_loc3_] ^= param1 >> 8 & 255;
         var _loc4_:*;
         this.var_146[_loc4_ = this.var_106++] = this.var_146[_loc4_] ^ param1 >> 16 & 255;
         var _loc5_:*;
         this.var_146[_loc5_ = this.var_106++] = this.var_146[_loc5_] ^ param1 >> 24 & 255;
         this.var_106 %= this.psize;
         this.var_2189 = true;
      }
