package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_2790:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_568 = [];
         this.var_569 = [];
         events.addEventListener(RoomContentLoadedEvent.const_371,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_419,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_671,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_567 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_567 == null || this.var_469 == null)
         {
            return;
         }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_568.indexOf(_loc5_) < 0)
            {
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_469.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_469.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_567.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_567 != null)
         {
            return this.var_567.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_641)
         {
            return;
         }
         if(this.var_47 == null)
         {
            this._state = const_641;
            return;
         }
         if(this.var_47.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_568.indexOf(param1);
            if(_loc2_ >= 0)
            {
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_47 == null || this.var_469 == null)
         {
            return;
         }
         ...
         var _loc5_:* = null;
         var _loc6_:int = this.var_110.length - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.var_110.getWithIndex(_loc6_) as RoomInstance;
            _loc8_ = this.var_110.getKey(_loc6_);
            if(_loc7_ != null)
            {
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = this.var_469.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = this.var_469.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = this.var_567.createRoomObjectLogic(_loc18_);
                                 ...
                                 if(this.var_149 != null)
                                 {
                                    this.var_149.objectInitialized(_loc8_,_loc14_.getId(),_loc11_);
                                 }
                              }
                           }
                           else
