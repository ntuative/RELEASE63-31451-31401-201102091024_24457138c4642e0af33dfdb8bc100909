package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_339:IRoomObjectController;
      ...
      {
         if(this.var_339 == param1)
         {
            return;
         }
         if(this.var_339 != null)
         {
            this.var_339.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_339 = param1;
            this.var_339.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_339 != null)
            {
               this.var_339.setLocation(param1.loc);
               this.var_339.setDirection(param1.dir);
            }
         }
      }
   }
