package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_836:Number = 64;
      
      public static const const_1023:Number = 32;
      ...
      private var var_168:Vector3d;
      
      private var var_169:Vector3d;
      
      private var var_1199:Vector3d;
      ...
      private var var_1906:Number = 1.0;
      
      private var var_1905:Number = 1.0;
      
      private var var_1907:Number = 1.0;
      
      private var var_78:Vector3d;
      
      private var var_261:Vector3d;
      
      private var var_2775:Number = -500.0;
      
      private var var_2776:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1199 = new Vector3d();
         this.var_1906 = 1;
         this.var_1905 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1907 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_169.x,this.var_169.y,this.var_169.z);
      }
      
      public function get location() : IVector3d
      {
         return new Vector3d(this.var_78.x * this.var_425,this.var_78.y * this.var_427,this.var_78.z * this.var_426);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_261.x,this.var_261.y,this.var_261.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_425 != param1 * this.var_1906)
         {
            this.var_425 = param1 * this.var_1906;
            ++this.var_160;
         }
      }
      ...
      {
         if(this.var_427 != param1 * this.var_1905)
         {
            this.var_427 = param1 * this.var_1905;
            ++this.var_160;
         }
      }
      ...
      {
         if(this.var_426 != param1 * this.var_1907)
         {
            this.var_426 = param1 * this.var_1907;
            ++this.var_160;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_78.x;
         var _loc3_:Number = this.var_78.y;
         var _loc4_:Number = this.var_78.z;
         this.var_78.assign(param1);
         this.var_78.x /= this.var_425;
         this.var_78.y /= this.var_427;
         this.var_78.z /= this.var_426;
         if(this.var_78.x != _loc2_ || this.var_78.y != _loc3_ || this.var_78.z != _loc4_)
         {
            ++this.var_160;
         }
      }
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_261.x;
         var _loc3_:Number = this.var_261.y;
         var _loc4_:Number = this.var_261.z;
         this.var_261.assign(param1);
         if(this.var_261.x != _loc2_ || this.var_261.y != _loc3_ || this.var_261.z != _loc4_)
         {
            ++this.var_160;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_168.assign(_loc24_);
            this.var_169.assign(_loc25_);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_168.assign(_loc19_);
            this.var_169.assign(_loc20_);
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_514 != null)
         {
            ...
            this.var_514.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_514.add(_loc3_,_loc4_);
            ++this.var_160;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_514 != null)
         {
            ...
            return this.var_514.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1199.assign(_loc22_);
         }
         else
         {
            this.var_1199.assign(_loc17_);
         }
         ++this.var_160;
      }
      ...
      {
         if(param1 == null || this.var_169 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(this.var_169,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_168);
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_169);
         return new Vector3d(_loc2_,_loc3_,_loc4_);
      }
      
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,this.var_78);
         _loc2_.x *= this.var_425;
         _loc2_.y *= this.var_427;
         _loc2_.z *= this.var_426;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1199);
         if(_loc3_ < this.var_2775 || _loc3_ > this.var_2776)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_168);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         var _loc6_:IVector3d = this.getDisplacenent(param1);
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,this.var_78);
            _loc2_.add(_loc6_);
            _loc2_.x *= this.var_425;
            _loc2_.y *= this.var_427;
            _loc2_.z *= this.var_426;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1199);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(this._x,_loc5_),Vector3d.product(this.var_168,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_78.x * this.var_425,this.var_78.y * this.var_427,this.var_78.z * this.var_426);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_169;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_425,param2.y * this.var_427,param2.z * this.var_426);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_425,param3.y * this.var_427,param3.z * this.var_426);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_425,param4.y * this.var_427,param4.z * this.var_426);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1023;
         }
         else
         {
            this.scale = const_836;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_836;
      }
