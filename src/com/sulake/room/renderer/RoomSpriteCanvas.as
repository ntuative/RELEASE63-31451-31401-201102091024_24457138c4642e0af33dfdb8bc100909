package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1701:int = 50;
      ...
      private var var_619:RoomObjectCache;
      
      private var var_507:Array;
      
      private var var_621:Array;
      
      private var var_1447:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2636:Number = -1.0E7;
      
      private var var_2638:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_253.addChild(this.var_57);
         ...
         this.var_254 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         ...
         this.var_619 = new RoomObjectCache(_loc6_);
      ...
      {
         this.var_506.x -= param1 - this.var_618;
         this.var_618 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_506.y -= param1 - this.var_622;
         this.var_622 = param1;
      }
      ...
      {
         if(param1 && !this.var_948)
         {
            this.var_948 = true;
            if(this.var_132 != null && !this.var_253.contains(this.var_132))
            {
               this.var_253.addChild(this.var_132);
               this.var_57.mask = this.var_132;
            }
         }
         else if(!param1 && this.var_948)
         {
            this.var_948 = false;
            if(this.var_132 != null && this.var_253.contains(this.var_132))
            {
               this.var_253.removeChild(this.var_132);
      ...
      {
         this.var_619.removeObjectCache(param1);
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(param1 == this.var_2635)
         {
            return;
         }
         this.var_254.compress();
         ...
         if(this.var_766 != this.var_2634 || this._ht != this.var_2637)
         {
            _loc9_ = true;
         }
         if(this.var_57.x != this.var_618 || this.var_57.y != this.var_622)
         {
            this.var_57.x = this.var_618;
            this.var_57.y = this.var_622;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_507.sortOn("z",0 | 0);
         if(_loc5_ < this.var_507.length)
         {
            this.var_507.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_507[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2634 = this.var_766;
         this.var_2637 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_619.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_619.getObjectCache(param2);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_622;
                  if(_loc19_ < this.var_766 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_507.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_618;
                     _loc17_.y = _loc20_ - this.var_622;
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_765 || this.var_765 == 0)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_507.length)
         {
            return null;
         }
         return this.var_507[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = this.var_254.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_254.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_254.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            if(name.length > 0)
            {
               this.var_254.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_1176 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1874;
         }
         this.var_1874 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1176;
         return this.var_1874;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_766 / 2;
         var _loc12_:Number = param2 - this._ht / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1873,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_620.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_620.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2636 || param2 != this.var_2638)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_620.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_620.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_358 != null && param1 != null)
         {
            this.var_358.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_358 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_358.getKey(_loc1_);
            _loc3_ = this.var_358.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1447.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
