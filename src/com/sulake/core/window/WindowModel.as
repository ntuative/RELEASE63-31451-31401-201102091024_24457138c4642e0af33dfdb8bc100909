package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_435:uint = 10;
      
      protected var var_794:Boolean = true;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         this.var_80 = param4;
         this.var_793 = param8 == null ? new Array() : param8;
         this.var_16 = param6;
         this.var_11 = param7.clone();
         this.var_374 = param7.clone();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this.var_11 = null;
            this.var_16 = null;
            this._state = WindowState.const_456;
            this.var_793 = null;
         }
      }
      ...
      {
         return this.var_374.width;
      }
      
      public function getInitialHeight() : int
      {
         return this.var_374.height;
      }
