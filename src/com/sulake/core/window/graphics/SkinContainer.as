package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_911:uint = 8;
      
      private static const const_1254:String = "skin";
      
      private static const const_1253:String = "bitmap";
      
      private static const const_1255:String = "fill";
      
      private static const const_1251:String = "text";
      
      private static const const_1250:String = "label";
      
      private static const const_1252:String = "shape";
      ...
      private var var_387:Dictionary;
      
      private var var_1598:Dictionary;
      
      private var var_2247:Dictionary;
      
      private var var_2248:Dictionary;
      
      private var var_2249:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_841 = new Dictionary();
         this.var_840 = new Dictionary();
         this.var_1598 = new Dictionary();
         this.var_2247 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1598,this.var_2247);
         this.var_2248 = new Dictionary();
         this.var_2249 = new Dictionary();
         StateCodeTable.fillTables(this.var_2248,this.var_2249);
         this.var_387 = new Dictionary();
         this.var_387[const_1254] = BitmapSkinRenderer;
         this.var_387[const_1253] = BitmapDataRenderer;
         this.var_387[const_1255] = FillSkinRenderer;
         this.var_387[const_1251] = TextSkinRenderer;
         this.var_387[const_1250] = LabelRenderer;
         this.var_387[const_1252] = ShapeSkinRenderer;
         this.var_387[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_387[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_309 == null)
         {
            var_309 = new Array();
            var_309.push(WindowState.const_72);
            var_309.push(WindowState.const_77);
            var_309.push(WindowState.const_89);
            var_309.push(WindowState.const_49);
            var_309.push(WindowState.const_84);
            var_309.push(WindowState.const_81);
            var_309.push(WindowState.const_101);
            var_309.push(WindowState.const_94);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2717 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1598[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_841[param1] == null)
         {
            this.var_841[param1] = new Array(const_911);
         }
         this.var_841[param1][param2] = param3;
         if(this.var_840[param1] == null)
         {
            this.var_840[param1] = new Array(const_911);
         }
         this.var_840[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_841[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_175)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_840[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_175)
