package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_370:Dictionary;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            {
               ISkinLayout(this.var_521[_loc1_]).dispose();
               delete this.var_521[_loc1_];
            }
            this.var_521 = null;
            this.var_429 = null;
            for(_loc1_ in this.var_370)
            {
               ISkinTemplate(this.var_370[_loc1_]).dispose();
               delete this.var_370[_loc1_];
            }
            this.var_370 = null;
      ...
      {
         var _loc3_:ISkinTemplate = this.var_370[param2];
         if(_loc3_ == null)
         {
      ...
      {
         this.var_521[param1.name] = param1;
         return param1;
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         var _loc2_:* = null;
         var _loc3_:* = 0;
         param1 = this.var_370[param1.name];
         if(param1 != null)
         {
            for(_loc2_ in this.var_429)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(this.var_429[_loc3_] == param1)
               {
                  this.removeLayoutFromRenderState(_loc3_);
               }
            }
            delete this.var_521[param1.name];
         }
         return param1;
      }
      ...
      {
         this.var_370[param1.name] = param1;
         return param1;
      }
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            ...
            delete this.var_370[param1.name];
         }
         return param1;
      }
   }
