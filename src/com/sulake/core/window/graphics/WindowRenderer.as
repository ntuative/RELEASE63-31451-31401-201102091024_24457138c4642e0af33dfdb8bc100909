package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1673:Point;
      
      private var var_1330:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_1673 = new Point();
         this.var_1330 = new Rectangle();
         this.var_296 = new Rectangle();
         this.var_333 = new Dictionary(true);
         this.var_860 = param1;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            this._disposed = true;
            this.var_705 = null;
            for(_loc1_ in this.var_333)
            {
               delete this.var_333[_loc1_];
            }
            this.var_333 = null;
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.var_296.x = param2.x - param1.x;
            this.var_296.y = param2.y - param1.y;
            this.var_296.width = param2.width;
            this.var_296.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_32))
            {
               while(param1.testParamFlag(WindowParam.const_32))
               {
                  ...
                  this.var_296.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            this.getWindowRendererItem(param1).invalidate(param1,this.var_296,WindowRedrawFlag.const_1198);
            if(this.var_705.indexOf(param1) == -1)
            {
               this.var_705.push(param1);
            }
         }
      }
      ...
      public function invalidate(param1:IWindowContext, param2:Rectangle) : void
      {
         ...
         while(_loc4_-- > 0)
         {
            ...
            this.addToRenderQueue(_loc5_,_loc5_.rectangle,WindowRedrawFlag.const_63);
         }
      }
      
      protected function getWindowRendererItem(param1:IWindow) : WindowRendererItem
      {
         var _loc2_:WindowRendererItem = this.var_333[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_333[param1];
         }
         return _loc2_;
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,this._drawBufferAllocator,this.var_860);
            this.var_333[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_709,this.windowDisposedCallback);
         }
      }
      
      public function removeRenderable(param1:IWindow) : void
      {
         param1.removeEventListener(WindowDisposeEvent.const_709,this.windowDisposedCallback);
         var _loc2_:WindowRendererItem = this.var_333[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
      ...
      public function render() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         var _loc2_:uint = this.var_705.length;
         _loc4_ = 0;
         while(_loc4_ < _loc2_)
         {
            _loc1_ = this.var_705.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = this.getWindowRendererItem(_loc1_);
               this.var_296.x = _loc3_.dirty.x;
               this.var_296.y = _loc3_.dirty.y;
               this.var_296.width = _loc3_.dirty.width;
               this.var_296.height = _loc3_.dirty.height;
               this.renderWindowBranch(_loc1_,this.var_296,_loc1_.rectangle.clone());
            }
            _loc4_++;
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1673,this.var_1330))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1673,this.var_1330))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_32))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1330);
