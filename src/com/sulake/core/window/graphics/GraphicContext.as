package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_980:uint = 2;
      
      public static const const_776:uint = 4;
      
      public static const const_1453:uint = 8;
      
      public static const const_1468:uint = 16;
      
      public static const const_1808:uint = 64;
      
      public static const const_1850:uint = 128;
      
      public static const const_1170:uint = 256;
      ...
      protected var var_199:DisplayObjectContainer;
      
      protected var var_1984:Boolean;
      
      protected var var_797:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_980:
               ...
               break;
            case GraphicContext.const_1453:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1468:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_776:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1170:
               break;
            case GraphicContext.const_1410:
               break;
            default:
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_199.numChildren > 0)
               {
                  this.var_199.removeChildAt(0);
               }
            }
            this.var_199 = null;
            while(numChildren > 0)
         ...
         if(this.var_797)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1984,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1984,16777215);
                  }
                  var_310 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_199 == null)
         {
            this.var_199 = new Sprite();
            this.var_199.name = this.name + " - Child Container";
            this.var_199.mouseEnabled = false;
      ...
      {
         return this.var_199 != null ? int(this.var_199.numChildren) : 0;
      }
