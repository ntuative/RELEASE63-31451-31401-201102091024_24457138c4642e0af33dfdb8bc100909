package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_195:String = "regular";
      ...
      private static var var_442:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_579:String = "{";
      
      private static const const_580:String = "}";
      
      private static const const_1225:String = "/*";
      
      private static const const_1226:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_82[const_195],var_82[ITALIC],var_82[BOLD]];
            var_82.reset();
            var_82[const_195] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_442.indexOf(_loc4_.name) == -1)
            {
               var_442.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_580);
         if(countSubStrings(param1,const_579) != countSubStrings(param1,const_580))
         {
            throw new Error("Mismatching amount of \"" + const_579 + "\" versus \"" + const_580 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1225) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1226) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_579)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
