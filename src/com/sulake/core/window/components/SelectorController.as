package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      private var var_186:ISelectableWindow;
      
      protected var var_1961:Boolean = true;
      ...
      {
         return this.var_186 as ISelectableWindow;
      }
         ...
         if(param1 != null)
         {
            if(param1 != this.var_186)
            {
               ...
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_352,this,this.var_186));
               }
            }
         }
      }
