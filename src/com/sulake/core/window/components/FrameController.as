package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1291:String = "_HEADER";
      
      private static const const_1292:String = "_CONTENT";
      
      private static const const_1290:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1339:IHeaderWindow;
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1339 = findChildByTag(const_1291) as IHeaderWindow;
            if(!this.var_1339)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_171 = findChildByTag(const_1292) as IWindowContainer;
            if(!this.var_171)
            {
      ...
      {
         return findChildByTag(const_1290) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1206,_loc2_,false);
      ...
      {
         return this.content != null && this.var_976 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc4_:Boolean = testParamFlag(WindowParam.const_248);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
            ...
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_248,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_248,false);
            }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_286,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_266,_loc3_.left,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_246,_loc3_.top,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_207,0 - _loc3_.right,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_241,0 - _loc3_.bottom,PropertyStruct.const_38,_loc2_));
         }
         else
         {
