package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_991:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_375)
         {
            this.var_375.removeEventListener(WindowEvent.const_284,this.scrollBarEventProc);
            this.var_375.removeEventListener(WindowEvent.const_234,this.scrollBarEventProc);
            this.var_375 = null;
         }
         if(this.var_991)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_991)
         {
            this.var_991 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return this.var_991;
      }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_375)
         {
            this.var_375 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_375)
            {
               this.var_375.addEventListener(WindowEvent.const_284,this.scrollBarEventProc);
               this.var_375.addEventListener(WindowEvent.const_234,this.scrollBarEventProc);
            }
         }
         return this.var_375;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_234)
         {
            this.hideScrollBar();
         }
      }
