package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1213:Boolean = false;
      ...
      {
         this.var_1221 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_980,var_11);
         }
         return var_21;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_476)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_690 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_16.handleError(WindowContext.const_330,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_831,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1429);
         _loc1_.push(this.var_1213 != PropertyDefaults.const_1192 ? new PropertyStruct(PropertyDefaults.const_837,this.var_1213,PropertyStruct.const_37,true) : PropertyDefaults.const_1597);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1074 ? new PropertyStruct(PropertyDefaults.const_629,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1378);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1073 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1367);
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_837:
                  this.var_1213 = _loc2_.value as Boolean;
                  if(this.var_1213)
                  {
                     var_16.getWindowServices().getFocusManagerService().registerFocusWindow(this);
                  }
                  break;
               case PropertyDefaults.const_629:
               ...
               case PropertyDefaults.const_831:
                  ...
                  break;
               case PropertyDefaults.const_1075:
