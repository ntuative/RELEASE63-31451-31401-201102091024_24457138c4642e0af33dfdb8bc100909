package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1205:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_790:Number;
      ...
      protected var var_117:Boolean = false;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_402,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_402 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_402,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_195);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_645 ? true : null;
         }
      ...
      {
         this.var_790 = param1;
         this._field.scrollH = this.var_790 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_790 * this.maxScrollH,this.var_523 * this.maxScrollV,width,height);
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!this.var_522)
         {
            if(param2.type == WindowNotifyEvent.const_183)
            {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1150) ? new PropertyStruct(PropertyDefaults.const_842,this._field.antiAliasType,PropertyStruct.const_51,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_976) : PropertyDefaults.const_1587);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1022 ? new PropertyStruct(PropertyDefaults.const_617,this._autoSize,PropertyStruct.const_51,true,PropertyDefaults.const_1033) : PropertyDefaults.const_1440);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_37,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_134,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_212,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1045 ? new PropertyStruct(PropertyDefaults.const_985,this._field.gridFitType,PropertyStruct.const_51,true,PropertyDefaults.const_1011) : PropertyDefaults.const_1583);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_871) ? new PropertyStruct(PropertyDefaults.const_401,this._field.textColor,PropertyStruct.const_134,true) : PropertyDefaults.const_1056);
         ...
         _loc1_.push(this.var_37.left != PropertyDefaults.const_680 ? new PropertyStruct(PropertyDefaults.const_266,this.var_37.left,PropertyStruct.const_38,true) : PropertyDefaults.const_447);
         _loc1_.push(this.var_37.top != PropertyDefaults.const_793 ? new PropertyStruct(PropertyDefaults.const_246,this.var_37.top,PropertyStruct.const_38,true) : PropertyDefaults.const_529);
         _loc1_.push(this.var_37.right != PropertyDefaults.const_833 ? new PropertyStruct(PropertyDefaults.const_207,this.var_37.right,PropertyStruct.const_38,true) : PropertyDefaults.const_458);
         _loc1_.push(this.var_37.bottom != PropertyDefaults.const_770 ? new PropertyStruct(PropertyDefaults.const_241,this.var_37.bottom,PropertyStruct.const_38,true) : PropertyDefaults.const_537);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1167 ? new PropertyStruct(PropertyDefaults.const_673,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1450);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_256,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_256,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_256,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
