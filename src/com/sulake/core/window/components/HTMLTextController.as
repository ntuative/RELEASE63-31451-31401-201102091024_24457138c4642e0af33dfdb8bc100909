package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_871:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_708:String;
      
      private var var_1073:String = null;
      
      private var var_1696:StyleSheet = null;
      ...
      {
         this.var_708 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1073 == param2)
         {
            return;
         }
         param1.var_1073 = param2;
         param1.var_1696 = null;
         if(param1.var_1073 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1073);
            param1.var_1696 = _loc3_;
         }
      }
      ...
      {
         return this.var_708 == LinkTarget.const_31 ? defaultLinkTarget : this.var_708;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1696;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_708 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_695,this.var_708,PropertyStruct.const_51,true,PropertyDefaults.const_742));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_695)
            {
               this.var_708 = _loc2_.value as String;
               break;
            }
