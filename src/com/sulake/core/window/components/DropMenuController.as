package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_404:String = "_DROPMENU_TITLETEXT";
      ...
      private var var_181:DropMenuController;
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_455,this,null,true);
         this.update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            this.var_624 = param1;
            this.closeMenuView();
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_352,this,null));
         }
      }
      ...
      {
         if(this.var_181 != null && !this.var_181.disposed)
         {
            this.var_181.destroy();
            this.var_181 = null;
         }
         super.dispose();
      }
      ...
      {
         return getChildByName(DropMenuController.const_404) as ILabelWindow;
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_181 == null || this.var_181.disposed)
         {
            this.var_181 = context.create(name + "::submenu","",WindowType.const_550,var_80,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_181.setGlobalRectangle(_loc1_);
         }
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_181.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_954 = false;
            this.getTitleLabel().text = this.var_624 < this.var_256.length && this.var_624 > -1 ? this.var_256[this.var_624] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_548,var_80,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_362,var_80,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_624 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_624).setStateFlag(WindowState.const_49,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_41 || param1.type == WindowTouchEvent.const_476)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1195:
            case WindowMouseEvent.const_56:
               ...
               break;
            case WindowTouchEvent.const_650:
      ...
      public function open() : Boolean
      {
         ...
         visible = true;
         _loc1_.type = WindowNotifyEvent.const_1141;
         this.update(this,_loc1_);
         return true;
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_256.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_610,this.var_256,PropertyStruct.const_143,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1567);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_610)
            {
