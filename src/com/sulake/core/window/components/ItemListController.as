package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_1979:Boolean = false;
      ...
      protected var var_2782:Number = 0.0;
      
      protected var var_2781:Number = 0.0;
      
      protected var var_983:Boolean = true;
      
      protected var var_437:Boolean = false;
      
      protected var var_1229:Boolean = false;
      
      protected var var_1980:int = 0;
      
      protected var var_1978:int = 0;
      
      protected var var_1230:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_101 = 0;
         this.var_91 = 0;
         this._horizontal = param2 == WindowType.const_336;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_162 = var_436 || !testParamFlag(WindowParam.const_32);
         this._container = var_16.create("_CONTAINER","",WindowType.const_362,WindowStyle.const_623,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this._container.addEventListener(WindowEvent.const_276,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_540,this.containerEventHandler);
         this.resizeOnItemUpdate = this.var_1229;
      }
      ...
      {
         return new Rectangle(this.var_645 * this.maxScrollH,this.var_646 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_645 = param1;
            this._container.x = -this.var_645 * this.maxScrollH;
            var_16.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_63);
            dispatchEvent(new WindowEvent(WindowEvent.const_466,this,null));
         }
      }
      ...
      {
         this.var_2782 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2781 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            ...
            {
               this._container.setParamFlag(WindowParam.const_420,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_276,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_176:
               if(this.var_1228)
               {
                  this.var_1230 = this.var_1980 - _loc3_;
                  this.var_1231 = this.var_1978 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1230 != 0 && this.var_101 != 0)
                     {
                        this.scrollH += this.var_1230 / this.var_101;
                     }
                  }
                  else if(this.var_1231 != 0 && this.var_91 != 0)
                  {
                     this.scrollV += this.var_1231 / this.var_91;
                  }
                  this.var_1980 = _loc3_;
                  this.var_1978 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_171:
               if(this.var_1228)
               {
                  if(this._horizontal)
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1230,0);
                  }
                  else
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1231);
                  }
                  this.var_1228 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_983 && !this.var_527 && this._container)
         {
            this.var_527 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_718)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_367,this._spacing,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_974);
         }
         if(this.var_983 != PropertyDefaults.const_1164)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_868,this.var_983,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1628);
         }
         if(this.var_437 != PropertyDefaults.const_1132)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_723,this.var_437,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1389);
         }
         if(this.var_1229 != PropertyDefaults.const_1104)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_829,this.var_1229,PropertyStruct.const_37,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_367:
                  ...
                  break;
               case PropertyDefaults.const_723:
               ...
               case PropertyDefaults.const_868:
                  this.var_983 = _loc2_.value as Boolean;
                  break;
            }
         }
