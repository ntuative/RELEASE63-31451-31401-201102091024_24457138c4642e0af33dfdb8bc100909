package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1299:String = "_SELECTOR";
      
      private static const const_1298:String = "_CONTENT";
       
      
      protected var var_980:ITabSelectorWindow;
      
      protected var var_1969:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_980 = findChildByTag(const_1299) as ITabSelectorWindow;
            if(this.var_980 != null)
            {
               this.var_980.procedure = this.selectorEventProc;
            }
         }
         return this.var_980;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1969 = findChildByTag(const_1298) as IWindowContainer;
         }
      ...
      {
         return this.var_980.numSelectables;
      }
