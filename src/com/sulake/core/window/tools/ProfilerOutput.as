package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1252:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1251:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_142:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_2745 = new Array();
         this.var_142 = this.profiler;
         this._windowManager = param2;
         this.var_887 = param3;
         var _loc4_:ByteArray = new var_1252() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_142)
         {
            this.var_142.removeStopEventListener(this.refresh);
            this.var_142 = null;
         }
         if(!this.var_142 && param1)
         {
            this.var_142 = param1;
            this.var_142.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_804)
            {
               this.var_1507 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_142.getProfilerAgentsInArray();
         ...
         if(this.var_1507)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_142.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_142.numBitmapAssetInstances + " / " + this.var_142.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_887.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_142.numTrackedBitmapDataInstances + " / " + this.var_142.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1251() as ByteArray;
