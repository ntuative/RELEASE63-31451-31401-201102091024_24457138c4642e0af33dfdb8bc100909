package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      private var var_466:ByteArray;
      
      private var var_1045:IEncryption;
      
      private var var_688:IProtocol;
      
      private var _id:String;
      
      private var var_1046:IMessageClassManager;
      
      private var var_293:ICoreCommunicationManager;
      
      private var var_465:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_293 = param2;
         this.var_466 = new ByteArray();
         this.var_1046 = new MessageClassManager();
         this.var_74 = new Socket();
         this.var_330 = new Timer(const_1616,1);
         this.var_330.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_465)
         {
            this.var_465.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_330.start();
         this.var_689 = getTimer();
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1046.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            this.logConnection("Could not find registered message composer for " + param1);
            return false;
         }
         var _loc5_:ByteArray = this.var_688.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_465)
         {
            this.var_465.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(this.var_1045 != null)
         {
            _loc3_ = this.var_1045.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      {
         this.var_1046.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_688.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_688.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1045 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_688.getMessages(this.var_466,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_465)
               {
                  this.var_465.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1046.getMessageEventClasses(id);
               events = new Array();
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_466,offset);
               this.var_466 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_466.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_466.writeByte(this.var_74.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_330.stop();
         this.var_1621 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_689));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1621 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_689));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_689));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_689));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_689));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_689));
         var _loc2_:IOErrorEvent = new IOErrorEvent(IOErrorEvent.IO_ERROR);
         _loc2_.text = "Socket Timeout (" + this.var_330.delay + " ms). Possible Firewall.";
