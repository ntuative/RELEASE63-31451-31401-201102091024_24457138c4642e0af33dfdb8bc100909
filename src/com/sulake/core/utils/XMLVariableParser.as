package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_134:String = "hex";
      
      public static const const_38:String = "int";
      
      public static const const_212:String = "uint";
      
      public static const const_256:String = "Number";
      
      public static const const_1394:String = "float";
      
      public static const const_37:String = "Boolean";
      
      public static const const_1498:String = "bool";
      ...
      private static const const_585:String = "key";
      
      private static const const_914:String = "type";
      
      private static const const_584:String = "value";
      
      private static const const_591:String = "true";
      
      private static const const_1671:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         _loc7_ = param1.attribute(const_585);
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_585));
         }
         else
         {
            _loc4_ = param1.child(const_585)[0];
         }
         _loc7_ = param1.attribute(const_914);
         if(_loc7_.length() > 0)
         {
            _loc5_ = String(param1.attribute(const_914));
         }
         _loc7_ = param1.attribute(const_584);
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_584));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_584)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_257 || _loc5_ == const_143)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1394:
               return Number(param1);
            case const_37:
               return param1 == const_591 || int(param1) > 0;
            case const_1498:
               return param1 == const_591 || int(param1) > 0;
            case const_134:
               return uint(param1);
            case const_143:
               return param1.split(const_1263);
            default:
      ...
      public static function parseValueType(param1:XML, param2:String) : Object
      {
         ...
         switch(param2)
         {
            ...
            case const_263:
               ...
               _loc5_.width = Number(param1.attribute(const_1264));
               _loc5_.height = Number(param1.attribute(const_1262));
               return _loc5_;
            case const_143:
               _loc3_ = new Map();
