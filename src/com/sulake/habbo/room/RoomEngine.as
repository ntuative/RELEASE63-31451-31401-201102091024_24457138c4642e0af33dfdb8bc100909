package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_603:String = "temporary_room";
      
      private static const const_326:int = -1;
      
      private static const const_602:String = "room";
      
      private static const const_958:int = -2;
      
      private static const const_1342:String = "tile_cursor";
      
      private static const const_959:int = -3;
      
      private static const const_1343:String = "selection_arrow";
      
      private static const const_960:String = "overlay";
      
      private static const const_325:String = "object_icon_sprite";
      
      private static const const_415:int = 15;
      ...
      private var var_963:IRoomRendererFactory = null;
      ...
      private var var_376:ISessionDataManager = null;
      ...
      private var var_773:NumberBank;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_773 = new NumberBank(1000);
         this.var_1196 = new Map();
         this.var_365 = new Map();
         this.var_72 = new RoomObjectEventHandler(this);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_469.release(new IIDRoomObjectVisualizationFactory());
            this.var_469 = null;
         }
         if(this.var_45 != null)
         {
         ...
         {
            this.var_963.release(new IIDRoomRendererFactory());
            this.var_963 = null;
         }
         ...
         if(this.var_366 != null)
         {
            ...
            {
               _loc2_ = this.var_366.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         var _loc4_:RoomInstanceData = this.var_366.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            this.var_366.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_45 != null)
         {
            ...
            _loc2_ = this.var_45.getRoom(this.getRoomIdentifier(this.var_100,this.var_99));
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_366.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  ...
                  if(_loc5_ != this.var_100 || _loc6_ != this.var_99 || !this.var_1195)
                  {
      ...
      private function updateRoomCamera(param1:int, param2:int, param3:int, param4:Vector3d, param5:uint) : void
      {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc13_ != null)
            {
               _loc14_ = _loc10_.getNumber(RoomVariableEnum.const_611) - 0.5;
               _loc15_ = _loc10_.getNumber(RoomVariableEnum.const_854) - 0.5;
               _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_731) + 0.5;
               _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_828) + 0.5;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_469 = param2 as IRoomObjectVisualizationFactory;
         if(this.var_13 != null)
         {
            this.var_13.visualizationFactory = this.var_469;
         }
         this.initializeRoomManager();
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_45 != null)
         {
            ...
            this.var_45.addObjectUpdateCategory(RoomObjectCategoryEnum.const_293);
            this.var_45.addObjectUpdateCategory(RoomObjectCategoryEnum.const_78);
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_963 = param2 as IRoomRendererFactory;
         this.initializeRoomManager();
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_13 != null)
         {
            events.addEventListener(RoomContentLoader.const_834,this.onContentLoaderReady);
            this.var_13.initialize(events,this.var_130);
         }
         this.initializeRoomManager();
      }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_834)
         {
            this.var_2698 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_278.events.addEventListener(AdEvent.const_539,this.showRoomAd);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_13.sessionDataManager = this.var_376;
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_25 != null)
         {
            ...
            {
               this.var_25.events.addEventListener(RoomObjectMouseEvent.const_259,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectMouseEvent.const_565,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectMouseEvent.const_568,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectStateChangeEvent.const_125,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectStateChangeEvent.const_738,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_138,this.roomObjectEventHandler);
               ...
               this.var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_142,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_129,this.roomObjectEventHandler);
               ...
               this.var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_99,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_124,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_569,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_DICE_OFF,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_472,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_518,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_446,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_519,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_520,this.roomObjectEventHandler);
               ...
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_553,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_457,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_552,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_495,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_62,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectMoveEvent.const_560,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectMoveEvent.const_418,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomAdEvent.const_280,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomAdEvent.const_469,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomAdEvent.const_356,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomAdEvent.const_329,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomActionEvent.const_528,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomActionEvent.const_1055,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomActionEvent.const_535,this.roomObjectEventHandler);
            }
         }
      }
      ...
      {
         if(this.var_25 == null || this.var_469 == null || this.var_45 == null || this.var_963 == null || this._communication == null || this.var_130 == null || !this.var_2698)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_511 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_652,0,0));
            _loc2_ = 0;
            while(_loc2_ < this.var_365.length)
            {
               _loc3_ = this.var_365.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc5_ == 0)
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_473,param1,param2));
            }
            else
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_512,param1,param2));
            }
         }
      }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         if(!this.var_511)
         {
            _loc5_ = this.var_365.remove(_loc4_);
            if(_loc5_ != null)
            {
            ...
            this.var_365.add(_loc4_,_loc5_);
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_662,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1020,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_614,1,true);
            _loc13_ = parseInt(this.var_130.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1135,_loc13_,true);
            if(this.var_13 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_326,const_602,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_614,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_856,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_611,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_731,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_854,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_828,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1026,_loc14_,true);
               }
            }
         }
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_839,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_781,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_702,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_508,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_209);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_703,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_812,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_703,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_812,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1067,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1175,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_958,const_1342,RoomObjectCategoryEnum.const_293);
         _loc7_.createRoomObject(const_959,const_1343,RoomObjectCategoryEnum.const_293);
         return _loc7_;
      }
      
      public function getObjectRoom(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_326,RoomObjectCategoryEnum.const_78);
      }
      
      public function method_11(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         var _loc8_:* = null;
         var _loc9_:* = null;
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = this.var_365.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               this.var_365.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_839,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_781,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_702,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1137,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1103,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = this.var_366.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_618,param1,param2));
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = this.var_963.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1186;
         ...
         _loc10_.mouseListener = this.var_72;
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_856);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_703);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_812);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1067);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1175);
      ...
      {
         var _loc8_:int = param2 - this.var_1457;
         var _loc9_:int = param3 - this.var_1458;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1195 = true;
               this.var_962 = false;
               this.var_2697 = this.var_1457;
               this.var_2696 = this.var_1458;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1195)
            {
               if(!this.var_962)
               {
                  _loc8_ = param2 - this.var_2697;
                  _loc9_ = param3 - this.var_2696;
                  if(_loc8_ <= -const_415 || _loc8_ >= const_415 || _loc9_ <= -const_415 || _loc9_ >= const_415)
                  {
                     this.var_962 = true;
                  }
                  _loc8_ = 0;
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_100,this.var_99,param1);
         if(_loc9_ != null)
         {
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_431,this.var_100,this.var_99,-1,RoomObjectCategoryEnum.const_160));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_72 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_326,const_602);
                     this.var_72.handleRoomObjectEvent(_loc14_,this.var_100,this.var_99);
                  }
               }
            }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_960) as Sprite;
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc5_ = this.getRoomObjectImage(this.var_100,this.var_99,param1,param2,new Vector3d(),1,null);
         }
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_100,this.var_99,this.var_1456);
         if(_loc6_ != null)
         {
            ...
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1457 - _loc5_.data.width / 2;
               _loc10_.y = this.var_1458 - _loc5_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_100,this.var_99,this.var_1456);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_100,this.var_99,this.var_1456);
         if(_loc1_ != null)
         {
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_72 != null)
         {
            return this.var_72.modifyRoomObject(this.var_100,this.var_99,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_72 != null)
         {
            ...
            {
               return this.var_72.modifyWallItemData(this.var_100,this.var_99,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_72 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_27)
            {
               return this.var_72.deleteWallItem(this.var_100,this.var_99,param1);
            }
         }
         return false;
      }
      ...
      {
         var _loc5_:IRoomInstance = this.getRoom(this.var_100,this.var_99);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_614) != 0)
         {
            return false;
         }
         if(this.var_72 != null)
         {
            return this.var_72.initializeRoomObjectInsert(this.var_100,this.var_99,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_72 != null)
         {
            this.var_72.cancelRoomObjectInsert(this.var_100,this.var_99);
         }
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_959,RoomObjectCategoryEnum.const_293);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_958,RoomObjectCategoryEnum.const_293);
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_399,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_373,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1188,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1018,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1168,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_271,param1,param2,param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE));
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_399,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_373,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_1186,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_271,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1037) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_983);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_508,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_715,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_271,param1,param2,param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_USER));
         }
         return true;
      }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_290);
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_887,this.var_100,this.var_99,param2,param3));
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_72 != null)
         {
            this.var_72.handleRoomObjectEvent(param1,this.var_100,this.var_99);
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_27:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_444);
                     break;
                  case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_170);
               }
            }
         }
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               _loc8_.addPlane(RoomPlaneData.const_178,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
               ...
               _loc8_.addPlane(RoomPlaneData.const_282,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
               _loc9_ = _loc8_.getXML();
               param1.getEventHandler().initialize(_loc9_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_701,_loc4_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_744,_loc5_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_740,_loc6_);
               if(_loc7_ != null)
               {
                  _loc10_ = null;
                  _loc11_ = "undefined_1";
                  _loc10_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_508,_loc11_,_loc7_,new Vector3d(2,0,1.75));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null) : ImageResult
      {
         ...
         _loc8_.id = -1;
         if(!this.var_511 || param1 == null)
         {
            return _loc8_;
         }
         var _loc9_:IRoomInstance = this.var_45.getRoom(const_603);
         if(_loc9_ == null)
         {
            _loc9_ = this.var_45.createRoom(const_603,null);
            if(_loc9_ == null)
            {
               return _loc8_;
            }
         }
         var _loc10_:int = this.var_773.reserveNumber();
         ...
         switch(_loc11_)
         {
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
            case RoomObjectCategoryEnum.const_27:
               _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_250,int(param2));
               _loc12_.getModelController().setString(RoomObjectVariableEnum.const_444,param7);
               break;
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               if(param1 == "user" || param1 == "bot" || param1 == "pet")
               {
                  _loc12_.getModelController().setString(RoomObjectVariableEnum.const_170,param2);
               }
               else
               {
         ...
         {
            this.var_1196.add(String(_loc10_),param5);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_1116,param4,true);
         }
         else
         {
            _loc9_.disposeObject(_loc10_,_loc11_);
            this.var_773.freeNumber(_loc10_ - 1);
            _loc8_.id = 0;
         }
         _loc14_.dispose();
         return _loc8_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_100,this.var_99,const_326,RoomObjectCategoryEnum.const_78,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this.var_45.getRoom(const_603);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1116);
               ...
               this.var_773.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1196.remove(String(_loc10_)) as IGetImageListener;
      ...
      public function selectAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         if(this.var_72 != null)
         {
            this.var_72.setSelectedAvatar(param1,param2,param3,param4);
         }
      }
      ...
      public function getSelectedAvatarId() : int
      {
         if(this.var_72 != null)
         {
            return this.var_72.getSelectedAvatarId();
         }
         return -1;
      }
      ...
      public function selectRoomObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         this.var_72.setSelectedObject(param1,param2,param3,param4);
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_13 != null)
         {
            ...
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_992,param1.adWarningL,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1176,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1039,RoomObjectVariableEnum.const_384,param1.clickUrl);
