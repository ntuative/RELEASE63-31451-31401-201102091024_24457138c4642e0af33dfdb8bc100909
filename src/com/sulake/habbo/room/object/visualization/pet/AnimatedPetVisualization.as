package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_604:int = 1;
      
      private static const const_962:int = 1000;
      
      private static const const_1347:String = "pet_experience_bubble_png";
      ...
      private var var_319:AnimatedPetVisualizationData = null;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_319 = param1 as AnimatedPetVisualizationData;
         var _loc2_:* = null;
         if(this.var_319.commonAssets != null)
         {
            _loc3_ = this.var_319.commonAssets.getAssetByName(const_1347) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_361);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_217);
            this.validateActions(_loc4_,_loc5_);
            this._isSleeping = _loc3_.getNumber(RoomObjectVariableEnum.const_372) > 0;
            this.var_1680 = _loc3_.getNumber(RoomObjectVariableEnum.const_290);
            this.var_1336 = _loc3_.getNumber(RoomObjectVariableEnum.const_613);
            this.var_2030 = _loc3_.getNumber(RoomObjectVariableEnum.const_690);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.PET_PALETTE_INDEX);
            if(_loc6_ != this.var_1925)
            {
               this.var_1925 = _loc6_;
               this.var_2714 = this.var_1925.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this._experienceData != null)
         {
            ...
            if(this.var_1336 > 0)
            {
               _loc2_ = param1 - this.var_1336;
               if(_loc2_ < const_962)
               {
                  this._experienceData.alpha = int(Math.sin(_loc2_ / const_962 * 0) * 255);
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         {
            this.var_252 = param1;
            _loc3_ = this.var_319.getAnimationForPosture(var_184,param1);
            this.setAnimationForIndex(const_1349,_loc3_);
         }
         if(param2 != this.var_1335)
         {
            this.var_1335 = param2;
            _loc3_ = this.var_319.getAnimationForGesture(var_184,param2);
      ...
      {
         return super.getAdditionalSpriteCount() + const_604;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            _loc2_ = assetCollection.getAssetWithPalette(param1,this.var_2714);
            if(_loc2_ == null)
            {
            }
            return _loc2_;
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_604)
         {
            _loc4_ = _data.getSize(param1);
            if(param2 < _loc3_ - (1 + const_604))
            {
               if(_data == null || param2 >= FurnitureVisualizationData.const_515.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_515[param2];
               if(_loc4_ == 1)
               {
