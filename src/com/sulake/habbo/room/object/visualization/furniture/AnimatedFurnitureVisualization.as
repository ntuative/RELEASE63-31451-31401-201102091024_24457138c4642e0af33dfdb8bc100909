package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      private var var_319:AnimatedFurnitureVisualizationData = null;
      
      private var _state:int = -1;
      
      private var var_105:AnimationStateData;
      
      private var var_1535:int = 0;
      
      private var var_1007:Number = 0;
      ...
      {
         super();
         this.var_105 = new AnimationStateData();
      }
      ...
      {
         return this.var_105.animationId;
      }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_319 = param1 as AnimatedFurnitureVisualizationData;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            if(_loc4_ != this._state)
            {
               ...
               if(_loc5_ != null)
               {
                  _loc6_ = _loc5_.getNumber(RoomObjectVariableEnum.const_827);
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_827);
      ...
      protected function setAnimation(param1:int) : void
      {
         ...
         {
            this.setSubAnimation(this.var_105,param1,this._state >= 0);
         }
      }
      ...
      protected function setSubAnimation(param1:AnimationStateData, param2:int, param3:Boolean = true) : Boolean
      {
         ...
         if(param3)
         {
            ...
            if(param2 != _loc5_)
            {
               ...
               if(this.var_319.hasAnimation(this.var_1007,_loc6_))
               {
      ...
      {
         return this.var_105.getLastFramePlayed(param1);
      }
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_105 != null)
         {
            this.var_105.setLayerCount(this.var_602);
         }
      }
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         ...
         if(param1 != this.var_1007)
         {
            this.var_1007 = param1;
            this.var_602 = this.var_319.getLayerCount(param1);
      ...
      {
         var _loc2_:* = null;
         if(!this.var_105.animationOver)
         {
            _loc2_ = this.updateFramesForAnimation(this.var_105,param1);
            if(this.var_105.animationOver)
            {
               if(AnimationData.isTransitionFromAnimation(this.var_105.animationId) || AnimationData.isTransitionToAnimation(this.var_105.animationId))
               {
                  this.setAnimation(this.var_105.animationAfterTransitionId);
                  this.var_105.animationOver = false;
               }
            }
         }
         return _loc2_;
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : Array
      {
         ...
         if(_loc3_ == 0)
         {
            _loc3_ = this.var_319.getStartFrame(param2,_loc4_,_direction);
         }
         _loc3_ += 1;
         param1.frameCounter = _loc3_;
         var _loc6_:* = null;
         param1.animationOver = true;
         var _loc7_:int = this.var_602 - 1;
         while(_loc7_ >= 0)
         {
            ...
            if(!_loc8_)
            {
               ...
               if(_loc10_ == null || _loc10_.remainingFrameRepeats >= 0 && _loc12_ <= 0)
               {
                  ...
                  if(_loc11_ == AnimationFrame.const_1059)
                  {
                     _loc10_ = this.var_319.getFrame(param2,_loc4_,_direction,_loc7_,_loc3_);
                  }
                  else
                  {
                     _loc10_ = this.var_319.getFrameFromSequence(param2,_loc4_,_direction,_loc7_,_loc11_,_loc10_.activeSequenceOffset + _loc10_.repeats,_loc3_);
                  }
               ...
               if(_loc10_ == null || _loc10_.remainingFrameRepeats == AnimationFrame.const_440)
               {
                  _loc9_ = true;
                  _loc8_ = true;
               }
      ...
      {
         var _loc3_:AnimationFrame = this.var_105.getFrame(param2);
         if(_loc3_ != null)
         {
            return _loc3_.id;
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:AnimationFrame = this.var_105.getFrame(param3);
         if(_loc5_ != null)
         {
            _loc4_ += _loc5_.x;
         }
