package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemParticle
   {
      ...
      public function init(param1:Number, param2:Number, param3:Number, param4:Vector3D, param5:Number, param6:Number, param7:int, param8:Boolean = false, param9:Array = null, param10:Boolean = false) : void
      {
         ...
         this.var_1548 = this._x - this._direction.x * param6;
         this.var_1547 = this.var_168 - this._direction.y * param6;
         this.var_1544 = this.var_169 - this._direction.z * param6;
         this.var_448 = 0;
         this.var_1009 = false;
         this.var_813 = param7;
         this.var_2115 = param8;
         this._frames = param9;
         this.var_1546 = param10;
         this._alphaMultiplier = 1;
         this.var_1545 = 0.5 + Math.random() * 0.5;
      }
      
      public function update() : void
      {
         ++this.var_448;
         if(this.var_448 == this.var_813)
         {
            this.ignite();
         }
         if(this.var_1546)
         {
            if(this.var_448 / this.var_813 > this.var_1545)
            {
               this._alphaMultiplier = (this.var_813 - this.var_448) / (this.var_813 * (1 - this.var_1545));
            }
         }
      }
      ...
      public function getAsset() : IGraphicAsset
      {
         ...
         {
            return this._frames[this.var_448 % this._frames.length];
         }
         return null;
      }
      ...
      {
         return this.var_448 <= this.var_813;
      }
