package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_1089:Dictionary;
      ...
      private var var_238:IRoomObjectSprite;
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_1089)
         {
            _loc1_.dispose();
         }
         this.var_1089 = null;
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_92 = this.var_1089[param1];
         this.var_882 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_1732 >= 0)
         {
            this.var_238 = this._visualization.getSprite(this.var_1732);
            if(this.var_238 && this.var_238.asset)
            {
               if(this.var_238.width <= 1 || this.var_238.height <= 1)
               {
                  return;
               }
               if(this.var_83 == null)
               {
                  this.var_83 = this.var_238.asset.clone();
                  if(this.var_725.alphaMultiplier != 1)
                  {
                     this.var_580 = new BitmapData(this.var_83.width,this.var_83.height,true,4278190080);
                  }
               }
               this.var_2447 = -this.var_238.offsetX;
               this.var_2445 = -this.var_238.offsetY;
               this.var_238.asset = this.var_83;
            }
            if(this.var_83)
            {
            ...
            if(this.var_580)
            {
               this.var_580.fillRect(this.var_580.rect,4278190080);
            }
         }
      }
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_92.y * this.var_1090;
         }
         return 0;
      }
      ...
      {
         if(!this.var_92 || !this.var_238)
         {
            return;
         }
         if(this.var_83 && this.var_238.asset != this.var_83)
         {
            this.var_238.asset = this.var_83;
         }
         if(this.var_882)
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_882 && this.var_92.hasIgnited)
         {
            this.var_882 = true;
         }
         _loc8_ = this.var_1077 * this.var_1090;
         this.var_92.update();
         if(this.var_882)
         {
            if(this.var_92.roomObjectSpriteId >= 0)
            ...
            {
               this.var_83.draw(this.var_580,this.var_1733,this.var_725,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_92.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2447 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1090;
               _loc4_ = this.var_2445 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1090;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_1351.alphaMultiplier = _loc11_.alphaMultiplier;
                     this.var_83.draw(_loc7_,this._translationMatrix,this.var_1351,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
      ...
      public function parseData(param1:XML) : void
      {
         ...
         var _loc23_:* = null;
         var _loc24_:* = null;
         this.var_2446 = parseInt(param1.@size);
         this.var_1732 = !!param1.hasOwnProperty("@canvas_id") ? int(parseInt(param1.@canvas_id)) : -1;
         this.var_1077 = !!param1.hasOwnProperty("@offset_y") ? int(parseInt(param1.@offset_y)) : 10;
         this.var_1090 = this.var_2446 / 64;
         this.var_756 = !!param1.hasOwnProperty("@blend") ? Number(Number(param1.@blend)) : Number(1);
         this.var_756 = Math.min(this.var_756,1);
         this.var_725.alphaMultiplier = this.var_756;
