package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1562:int = 16777215;
      
      public static const const_1599:int = 13421772;
      
      private static const const_906:int = 16777215;
      
      private static const const_905:int = 13421772;
      
      private static const const_907:int = 10066329;
      
      private static const const_904:int = 10066329;
      
      public static const const_1465:int = 16777215;
      
      public static const const_1369:int = 13421772;
      
      public static const const_1515:int = 10066329;
      ...
      private var var_678:Rectangle = null;
      
      private var var_455:RoomPlaneBitmapMaskParser = null;
      
      private var var_1565:String = null;
      
      private var _floorType:String = null;
      
      private var var_1564:String = null;
      
      private var var_2151:String = null;
      
      private var var_1020:uint = 16777215;
      
      private var var_2152:int = 255;
      ...
      private const const_1948:int = 250;
      
      private var var_1484:int = -1;
      
      private var var_1236:Number = 0.0;
      
      private var var_1988:Number = 0.0;
      
      private var var_1990:Number = 0.0;
      
      private var var_1989:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_455 = new RoomPlaneBitmapMaskParser();
         this.var_284["null"] = false;
         this.var_284["null"] = true;
         this.var_284["null"] = true;
         this.var_284["null"] = true;
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_122.length)
            {
               _loc4_ = this.var_122[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_678 = super.boundingRectangle;
         }
         return new Rectangle(this.var_678.x,this.var_678.y,this.var_678.width,this.var_678.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_122.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_122[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1004);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1026);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            if(_loc12_ == RoomPlaneData.const_178)
            {
               ...
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1562;
               }
               else
               {
                  _loc13_.color = const_1599;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_154)
            {
               ...
               {
                  _loc13_.color = const_904;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_906;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_905;
               }
               else
               {
                  _loc13_.color = const_907;
               }
               if(this._data != null)
               {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_96,true,_loc11_,_loc6_,_loc5_,0,_loc3_,_loc4_);
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1465;
               }
               else if(_loc14_.y == 0)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1948 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         {
            _loc9_ = 0;
            while(_loc9_ < this.var_320.length)
            {
               _loc10_ = this.var_545[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_320[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_96)
               {
                  if(this.var_1563)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2154 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2150 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2152 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1484)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1236 || _loc3_.y != this.var_1988 || _loc3_.z != this.var_1990 || param1.scale != this.var_1989))
            {
               this.var_1236 = _loc3_.x;
               this.var_1988 = _loc3_.y;
               this.var_1990 = _loc3_.z;
               this.var_1989 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         var _loc2_:Boolean = false;
         if(var_161 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1107);
            if(_loc3_ != this.var_2151)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2151 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_877));
            if(_loc4_ != this.var_1020)
            {
               this.var_1020 = _loc4_;
               this.var_2154 = this.var_1020 & 255;
               this.var_2150 = this.var_1020 >> 8 & 255;
               this.var_2152 = this.var_1020 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1124));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_161 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_744);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_701);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_740);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_647));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_824));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_745));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_122.length)
         {
            _loc5_ = this.var_122[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_96 && param3 != null)
               {
                  _loc5_.id = param3;
               }
            }
      ...
      {
         if(param1 != this.var_284["null"] || param2 != this.var_284["null"] || param3 != this.var_284["null"])
         {
            this.var_284["null"] = param1;
            this.var_284["null"] = param2;
            this.var_284["null"] = param3;
            this.var_320 = [];
            this.var_545 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_320;
         if(this.var_320.length == 0)
         {
            _loc6_ = this.var_122;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_320.length > 0;
         var _loc9_:int = 0;
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_284[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_320.push(_loc12_);
                        this.var_545.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1562;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_455.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_122.length)
         {
            _loc3_ = this.var_122[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
               _loc3_.resetBitmapMasks();
               if(_loc3_.type == RoomPlane.const_96)
               {
                  _loc4_.push(_loc7_);
               }
            }
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_455.maskCount)
         {
            _loc10_ = this.var_455.getMaskType(_loc8_);
            _loc11_ = this.var_455.getMaskLocation(_loc8_);
            _loc12_ = this.var_455.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_122.length)
               {
                  _loc3_ = this.var_122[_loc13_] as RoomPlane;
                  if(_loc3_.type == RoomPlane.const_121 || _loc3_.type == RoomPlane.const_96)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_121 || _loc3_.type == RoomPlane.const_96 && _loc12_ == RoomPlaneBitmapMaskData.const_209)
                              {
                                 _loc3_.addBitmapMask(_loc10_,_loc16_,_loc17_);
                              }
                              else if(_loc3_.type == RoomPlane.const_96)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_122[_loc18_] as RoomPlane;
