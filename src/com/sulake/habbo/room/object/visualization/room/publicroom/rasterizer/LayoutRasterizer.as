package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1284:IGraphicAssetCollection;
      ...
      private var var_1118:Point = null;
      
      private var var_1383:LayoutRasterizerData = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_898)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1383 = this.var_41.getValue(this.var_898);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2516 = new Vector3d(-0.5,0.5,0);
         this.var_899 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2516);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
         _loc3_.x = Math.round(_loc3_.x);
         _loc3_.y = Math.round(_loc3_.y);
         this.var_1118.x = _loc3_.x;
         this.var_1118.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_41.getValue(this.var_898);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1778 = RoomObjectVariableEnum.const_992;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1778 = RoomObjectVariableEnum.const_1176;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1119 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1119 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_41.getValue(this.var_898);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2515 && param3 == this.var_2517)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1119 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1119 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1778);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_425;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1383.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_1284.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1118.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1118.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_411.indexOf(_loc10_) >= 0 && this.var_899)
            {
               param1 = this.var_411.indexOf(_loc10_);
               if(this.var_597[param1] != "")
               {
                  _loc9_ = this.var_1284.getAsset(this.var_597[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_596[param1] != -1)
               {
                  param2.alpha = this.var_596[param1];
               }
               this.var_411.splice(param1,1);
               this.var_597.splice(param1,1);
               this.var_596.splice(param1,1);
               if(this.var_411.length == 0)
               {
                  this.var_899 = false;
               }
            }
      ...
      {
         this.var_899 = true;
         var _loc3_:int = this.var_411.indexOf(param1);
         if(_loc3_ < 0)
         {
            this.var_411.push(param1);
            this.var_597.push(param2);
            this.var_596.push(-1);
         }
         else
         {
            this.var_597[_loc3_] = param2;
         }
      }
      ...
      public function changeElementAlpha(param1:String, param2:Number) : void
      {
         ...
         if(_loc3_ < 0)
         {
            this.var_411.push(param1);
            this.var_597.push("");
            this.var_596.push(param2);
         }
         else
         {
            this.var_596[_loc3_] = param2;
         }
      }
   }
}
