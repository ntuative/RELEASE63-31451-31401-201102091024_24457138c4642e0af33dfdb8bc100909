   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         else
         {
            ...
            this.var_2564 = param1.extra;
            this.var_1131 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1131 > 0 && param1 >= this.var_1131)
         {
            this.var_1131 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1791,String(this.var_1791),this.var_2564);
