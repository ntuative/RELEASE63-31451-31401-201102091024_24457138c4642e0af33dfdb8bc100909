package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_700,"");
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1039:
                  _loc2_.setString(RoomObjectVariableEnum.const_384,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_700,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_514,Number(true));
                  this.var_1370 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1135);
            }
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_425)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_700);
            ...
            case MouseEvent.ROLL_OUT:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_425)
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_329,_loc5_,_loc6_));
               }
         }
      }
   }
