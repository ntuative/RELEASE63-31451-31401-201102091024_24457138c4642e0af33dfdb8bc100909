package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1337:uint = 16777215;
      
      private var var_1683:int = 255;
      
      private var var_1068:uint = 16777215;
      
      private var var_1684:int = 255;
      
      private var var_1067:int = 0;
      
      private var var_1682:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1004,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_877,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_647,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_824,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1067)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1681;
            if(_loc2_ - this.var_1067 >= this.var_1682)
            {
               _loc3_ = this.var_1068;
               _loc4_ = this.var_1684;
               this.var_1067 = 0;
            }
            else
            {
               _loc7_ = this.var_1337 >> 16 & 255;
               _loc8_ = this.var_1337 >> 8 & 255;
               _loc9_ = this.var_1337 & 255;
               _loc10_ = this.var_1068 >> 16 & 255;
               _loc11_ = this.var_1068 >> 8 & 255;
               _loc12_ = this.var_1068 & 255;
               _loc13_ = (_loc2_ - this.var_1067) / this.var_1682;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1683 + (this.var_1684 - this.var_1683) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_877,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_839:
               param2.setString(RoomObjectVariableEnum.const_701,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_781:
               param2.setString(RoomObjectVariableEnum.const_744,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_702:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_508:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_209)
               {
                  _loc5_ = "null";
               }
               this.var_455.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_715:
               _loc4_ = this.var_455.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_455.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1107,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1103:
               param2.setNumber(RoomObjectVariableEnum.const_647,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1137:
               param2.setNumber(RoomObjectVariableEnum.const_824,_loc3_);
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1124,int(param1.bgOnly));
         this.var_1337 = this._color;
         this.var_1683 = this.var_1681;
         this.var_1068 = _loc3_;
         this.var_1684 = _loc4_;
         this.var_1067 = getTimer();
         this.var_1682 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1574,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1507,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1639,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_178)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_154 || _loc13_ == RoomPlaneData.const_282)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
