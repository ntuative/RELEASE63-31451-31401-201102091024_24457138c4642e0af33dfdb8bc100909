package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1247:int = 11;
      
      private static const const_582:int = 18;
      
      private static const const_910:int = 16;
      
      private static const const_1246:int = 20;
      ...
      private var var_273:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1035 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this._chatModeIdShout = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2242 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_326 = new Timer(1000,1);
         this.var_326.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_326.reset();
            this.var_326.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_326 = null;
         }
      ...
      private function createWindow() : void
      {
         ...
         _loc6_.addEventListener(WindowKeyboardEvent.const_182,this.windowKeyEventProcessor);
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_582 + const_910;
         _loc1_.x = const_582;
         _loc1_.y = const_1247;
      }
      ...
      {
         this.var_273 = param1 - (const_582 + const_910);
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1035 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_461 = "";
               }
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         this.setMaxWidth(this._window.context.getDesktopWindow().width - this._window.x - const_1246);
      }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_461.length + 1)
            {
               _loc2_.text = "";
            }
            this.var_461 = _loc2_.text;
            if(!this.var_555)
            {
               this.var_555 = true;
               this.var_326.reset();
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_555);
