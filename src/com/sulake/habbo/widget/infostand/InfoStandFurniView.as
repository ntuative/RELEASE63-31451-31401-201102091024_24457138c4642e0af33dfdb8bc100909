package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            _loc5_ = 0;
            while(_loc5_ < this.var_65.numListItems)
            {
               _loc4_ = this.var_65.getListItemAt(_loc5_);
               _loc4_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onButtonClicked);
               _loc5_++;
            }
         }
         this.var_859 = this.var_202.findChildByTag("catalog");
         if(this.var_859 != null)
         {
            this.var_859.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         this.var_65.visible = _loc2_ || _loc3_ || _loc4_;
         this.updateWindow();
      }
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_50.addListItem(this.var_859);
            }
            this.var_859.visible = param1;
         }
         else
         {
            this.var_50.removeListItem(this.var_859);
         }
      }
   }
}
