package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_143:IFrameWindow;
      
      private var var_539:IWindow;
      
      private var var_202:IBorderWindow;
      
      private var var_1178:TagListRenderer;
      
      private var var_120:IBorderWindow;
      
      private var var_2099:int;
      
      private const const_901:int = 5;
      
      private const const_1659:int = 39;
      
      private const const_1658:int = 7829367;
      
      private const const_1660:int = 16777215;
      
      private const const_1945:int = 2000;
      ...
      {
         if(this.var_50 == null || this.var_202 == null || this.var_65 == null)
         {
            return;
         }
         this.var_65.width = this.var_65.scrollableRegion.width;
         this.var_50.height = this.var_50.scrollableRegion.height;
         this.var_202.height = this.var_50.height + 20;
         this._window.width = Math.max(this.var_202.width,this.var_65.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_202.width < this.var_65.width)
         {
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:* = [];
         this.var_65.groupListItemsWithTag("CMD_BUTTON",_loc3_,true);
         for each(_loc4_ in _loc3_)
         {
            ...
            _loc4_.addEventListener(WindowEvent.const_45,this.onButtonResized);
         }
         if(this.var_202 != null)
         {
            this.var_50 = this.var_202.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         var _loc5_:IBitmapWrapperWindow = this.var_202.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc6_:IWindow = this.var_202.findChildByTag("close");
         if(_loc6_ != null)
         {
         ...
         {
            _loc7_ = 0;
            while(_loc7_ < this.var_65.numListItems)
            {
               _loc12_ = this.var_65.getListItemAt(_loc7_) as IRegionWindow;
               if(_loc12_ != null)
               {
         ...
         while(_loc7_ < 5)
         {
            _loc9_ = this.var_202.findChildByName("badge_" + _loc7_);
            if(_loc9_ != null)
            {
         ...
         _loc9_ = this.var_202.findChildByName("badge_group");
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_120.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_120.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_120.x = _loc5_.left - this.var_120.width;
         this.var_120.y = _loc5_.top + (_loc5_.height - this.var_120.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_120.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_120.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_120.x = _loc7_.left - this.var_120.width;
         this.var_120.y = _loc7_.top + (_loc7_.height - this.var_120.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_120 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_120 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_901;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1658;
            }
            else
            {
               _loc3_.textColor = this.const_1660;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_901;
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_328,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_328,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_191);
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = this.var_65.getListItemByName(param1) as IRegionWindow;
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetUserInfoUpdateEvent.const_191:
               this.var_65.visible = false;
               break;
            case RoomWidgetUserInfoUpdateEvent.const_230:
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IWindow = this.var_65.getListItemByName("respect");
         if(_loc1_ == null)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_1009:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1129:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2099 > this.const_1945 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2099 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1658;
            if(_loc3_.length >= this.const_1659)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1659 - 1);
            }
         }
      }
      ...
      {
         this.var_143 = this._widget.getXmlWindow("give_badge") as IFrameWindow;
         this.var_143.center();
         this.var_143.procedure = this.badgesEventProc;
         this.var_143.visible = param1;
      }
      
      public function updateGivableBadges() : void
      {
         if(this.var_143 && this.var_143.visible)
         {
            this.showGivableBadges();
         }
      }
      ...
      private function showGivableBadges() : void
      {
         ...
         this.var_539 = null;
         var _loc2_:IItemGridWindow = this.var_143.findChildByName("list.badges") as IItemGridWindow;
         if(_loc2_)
         {
      ...
      public function setGivableBadgeImage(param1:Array, param2:BitmapData) : void
      {
         ...
         var _loc3_:IItemGridWindow = this.var_143.findChildByName("list.badges") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _loc3_ = -1;
               _loc4_ = this.var_143.findChildByName("list.badges") as IItemGridWindow;
               if(_loc4_)
               {
                  _loc3_ = _loc4_.getGridItemIndex(this.var_539);
               }
               if(_loc3_ <= -1)
               {
                  return;
