package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_1444:Map;
      
      private var var_502:int;
      
      private const const_1983:int = 158;
      
      private const const_1981:int = 16;
      
      private const const_1986:uint = 11184810;
      
      private const const_1979:uint = 6710886;
      
      private const const_1985:uint = 3355443;
      
      private const const_1984:String = "level";
      
      private const const_1980:String = "experience";
      
      private const const_1978:String = "energy";
      
      private const const_1982:String = "nutrition";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1984,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1980,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1978,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1982,param1.nutrition,param1.nutritionMax);
         ...
         this.var_1444.remove(param1.id);
         this.var_1444.add(param1.id,param1);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1983,this.const_1981,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1986);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,this.const_1985);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,this.const_1979);
         return _loc5_;
      }
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this.var_1444.getValue(this.var_502) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            _loc9_ = this.var_65.getListItemAt(_loc4_) as IRegionWindow;
            if(_loc9_ != null)
            {
         ...
         var _loc7_:* = [];
         this.var_65.groupListItemsWithTag("CMD_BUTTON",_loc7_,true);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_196 && this.var_196.getPetId() == this.var_502)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_510,this._widget.petData.ownerId);
