package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_501:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_501.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_501 = null;
         }
         if(this.var_43 != null)
         {
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_501 == null)
         {
            this.var_501 = new Sprite();
            this.var_501.addChild(new Bitmap(this.var_43));
            this.var_501.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_501.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_43;
            }
         }
         _loc2_.setDisplayObject(this.var_501);
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1222 != "")
         {
            HabboWebTools.openWebPage(this.var_1222);
         }
      }
   }
}
