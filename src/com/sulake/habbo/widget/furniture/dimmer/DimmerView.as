package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private static const const_1209:Number = 100;
      
      private static const const_1208:Number = 100;
      ...
      private var var_419:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_57,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1209,const_1208,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            this.var_419 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
         this.var_239 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_239.numTabItems)
         {
            _loc6_ = this.var_239.getTabItemAt(_loc2_);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1439 = _loc2_.light;
         if(this.var_419 != null)
         {
            this.var_419.setValue(this.var_1439);
         }
         this.var_456 = this.colors.indexOf(_loc2_.color);
         if(this.var_612 != null)
         {
            this.var_612.setSelectedColorIndex(this.var_456);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_239.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_239.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_239.selector.getSelected();
         return this.var_239.selector.getSelectableIndex(_loc1_);
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_419 != null)
         {
            this.var_419.min = this._widget.minLights[param1 - 1];
         }
      }
