package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1295:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_173.state = RoomChatHistoryPulldown.const_262;
         ...
         this.var_46 = param2.createWindow("chatscroller","",HabboWindowType.const_1029,HabboWindowStyle.const_40,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_173.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_262);
      }
      ...
      {
         return !!this.var_406 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_173.state == RoomChatHistoryPulldown.const_338 || this.var_173.state == RoomChatHistoryPulldown.const_516;
      }
      ...
      {
         if(!this.var_406 && !this.var_1501)
         {
            this.var_406 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_173.state = RoomChatHistoryPulldown.const_338;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_46 != null)
         {
            ...
            if(param2)
            {
               this.var_46.scrollV = this.var_582;
            }
         }
         if(this.var_173 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_407 > 0 && param2)
         {
            if(this.var_1735)
            {
               if(Math.abs(param1 - this.var_407) <= const_1050)
               {
                  return;
               }
               this.var_1735 = false;
            ...
            if(this.var_406)
            {
               ...
               _loc5_ = (param1 - this.var_407) / this.var_46.height;
               _loc3_ = this.var_582 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_407;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_46.scrollV < 1 - const_1295 / this.var_46.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1736)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_46 != null)
         {
            this.var_582 = this.var_46.scrollV;
         }
         if(this.var_46 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_582 - this.var_46.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
