package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_357:String = "pets";
      
      private static const const_1341:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_240,this.onObjectPlaced);
         this._catalog = param7;
         this.var_629 = new Timer(const_1341,1);
         this.var_629.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_2694 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_240,this.onObjectPlaced);
               }
            ...
            {
               this.var_629.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_629.stop();
               this.var_629 = null;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_397)
         {
         ...
         else if(param3 == FurniCategory.const_387)
         {
         ...
         else if(param3 == FurniCategory.const_364)
         {
         ...
         if(this.var_961 == null)
         {
            this.var_961 = this._windowManager.buildFromXML(this.var_2694) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_961.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_42,const_46];
         var _loc5_:int = 0;
      ...
      {
         if(param1 == InventoryCategory.const_83 && this._controller.isVisible)
         {
            switch(this._view.method_1)
            {
               case const_42:
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_390);
      ...
      public function updateLocks() : void
      {
         ...
         var _loc7_:Array = [const_42,const_46];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_42,const_46];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_510.add(const_42,new Array());
         this.var_510.add(const_46,new Array());
         if(this._view != null)
         {
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_301;
      }
      ...
      {
         var _loc2_:GroupItem = this.getGroupItemInIndex(this.getSelectedItemIndex(),this._view.method_1);
         if(_loc2_ == null)
         {
            return false;
         }
         ...
         if(_loc3_.category == FurniCategory.const_387 || _loc3_.category == FurniCategory.const_397 || _loc3_.category == FurniCategory.const_364)
         {
            if(param1)
            {
               return false;
      ...
      {
         var _loc1_:GroupItem = this.getGroupItemInIndex(this.getSelectedItemIndex(),this._view.method_1);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      {
         if(this.var_1453 && param1.type == RoomEngineObjectEvent.const_240)
         {
            this.var_1453 = false;
         }
      }
      ...
      {
         return this.var_510.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = this.var_510.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = this.var_510.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_808)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
