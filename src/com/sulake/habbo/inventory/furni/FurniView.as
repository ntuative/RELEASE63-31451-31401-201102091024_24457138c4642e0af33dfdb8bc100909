package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1989:int = 0;
      
      private const const_920:int = 1;
      
      private const const_1683:int = 2;
      
      private const const_1682:int = 3;
      
      private const const_1686:int = 42;
      
      private const const_1685:int = 120;
      ...
      private var var_64:FurniModel;
      
      private var var_769:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_486.add(FurniModel.const_42,new FurniGridView(this.var_64,FurniModel.const_42,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_486.add(FurniModel.const_46,new FurniGridView(this.var_64,FurniModel.const_46,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         var _loc1_:Boolean = this.var_64.isTradingOpen;
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            case FurniModel.const_46:
               ...
               this.var_409 = FurniModel.const_46;
               break;
            case FurniModel.const_42:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_floor"));
               this.var_409 = FurniModel.const_42;
               break;
            case FurniModel.const_357:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_pets"));
               this.var_409 = FurniModel.const_357;
               break;
            default:
               throw new Error("Unknown item category: \"" + param1 + "\"");
         }
         this.var_64.furniCategorySwitch();
         this.showCategoryGrid(this.var_409);
         this.setViewToState();
      }
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_486.getValue(this.var_409);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_64.getCategoryContent(this.var_409);
         if(!this.var_64.isListInited())
         {
            _loc2_ = this.const_920;
         }
         ...
         {
            _loc2_ = this.const_1682;
         }
         if(this.var_2474 == _loc2_)
         {
            return;
         }
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_42,FurniModel.const_46];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_486.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_486.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_486.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         var _loc3_:int = this.var_64.getSelectedItemIndex();
         _loc4_ = this.var_64.getGroupItemInIndex(_loc3_,this.var_409);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_397)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_387)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_364)
            {
         ...
         var _loc12_:Boolean = this.var_64.isTradingOpen;
         _loc11_ = this._view.findChildByName("placeinroom_btn") as IButtonWindow;
         if(_loc11_)
         {
            if(_loc1_ && this.var_64.isPrivateRoom)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc11_)
         {
            if(_loc1_ && _loc4_ != null && _loc5_ != null && this.var_64.canUserOfferToTrade())
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_769 && this.var_769.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1685)
         {
            _loc3_ = this.const_1685;
         }
         else if(_loc3_ < this.const_1686)
         {
            _loc3_ = this.const_1686;
         }
         else
         {
      ...
      {
         var _loc3_:GroupItem = this.var_64.getGroupItemInIndex(this.var_64.getSelectedItemIndex());
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "placeinroom_btn":
                  this.var_64.requestSelectedFurniPlacement(false);
                  break;
               case "offertotrade_btn":
                  this.var_64.requestSelectedFurniToTrading();
                  break;
               case "sell_btn":
                  this.var_64.requestSelectedFurniSelling();
                  break;
               case "open_catalog_btn":
                  this.var_64.requestCatalogOpen();
                  break;
               default:
                  this.var_64.cancelFurniInMover();
            }
         }
         else if(param1.type == WindowEvent.const_59)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_357);
            }
         }
      }
   }
