package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1425:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         this.var_86 = this.var_606.height;
         this.var_1142 = param5;
         this.var_937 = param6;
         this.var_215 = Math.floor(this.var_1142 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1142,this.var_937);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         this.var_26 = new BitmapData(Math.max(this.var_215 * this._thumbWidth,this.var_1142),Math.max(this.var_607 * this.var_86,this.var_937),true,16777215);
            ...
            while(_loc4_ < this.var_215)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     this.var_26.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * this._thumbWidth,_loc3_ * this.var_86),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_215 && this.var_26.height < _loc3_.y * this.var_86)
         {
            _loc2_ = new BitmapData(this.var_26.width,this.var_26.height + this.var_86);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_215 - 1),this.var_86);
         ...
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(0,this.var_86),null,null,true);
         _loc4_ = new Rectangle(0,this.var_86,this._thumbWidth * (this.var_215 - 1),this.var_26.height - this.var_86);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(this._thumbWidth,this.var_86),null,null,true);
         this.var_26 = _loc2_;
      }
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1425.getDrawableList();
         }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(param1.y < this.var_607 - 1)
         {
            ...
            _loc8_ = this.var_26.height - (param1.y + 1) * this.var_86;
            ...
            this.var_26.fillRect(new Rectangle(0,this.var_26.height - this.var_86,this.var_26.width,this.var_86),4294967295);
            _loc3_ = new Point(this.var_26.width - this._thumbWidth,_loc2_.y - this.var_86);
         ...
         if(_loc6_ > 0)
         {
            ...
            {
               _loc11_ = new BitmapData(this.var_26.width,this.var_26.height - this.var_86);
               _loc2_ = new Rectangle(0,0,this.var_26.width,this.var_26.height - this.var_86);
               _loc11_.copyPixels(this.var_26,_loc2_,new Point(0,0),null,null,true);
               this.var_26 = _loc11_;
               --this.var_607;
            }
         }
         if(this.var_26.height < this.var_937)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_937);
