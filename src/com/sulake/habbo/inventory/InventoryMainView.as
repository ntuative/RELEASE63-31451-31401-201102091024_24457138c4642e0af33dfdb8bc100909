package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2753:IWindowContainer;
      
      private var _controller:HabboInventory;
      
      private var var_167:IHabboToolbar;
      
      private var var_1054:Boolean = true;
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this.var_167 != null && this.var_1054)
         {
            this.var_167.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            this.var_1054 = false;
         }
         this._controller.inventoryViewOpened(this.var_694);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != this.var_693 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
            if(this.var_167 != null && this.var_1054)
            {
               this.var_167.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
               this.var_1054 = false;
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_694);
      }
      ...
      public function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_167.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_116,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1634);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_693 == InventoryCategory.const_150)
            {
               this.toggleCategoryView(InventoryCategory.const_150);
            }
            else if(this.var_693 == InventoryCategory.const_83)
            {
