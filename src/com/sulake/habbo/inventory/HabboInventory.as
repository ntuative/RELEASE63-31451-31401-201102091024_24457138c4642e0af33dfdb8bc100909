package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1053:IRoomSession;
      ...
      private const const_1965:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_48)
         {
            _loc1_ = this.var_48.getKeys();
            _loc2_ = 0;
            while(_loc2_ < _loc1_.length)
            {
               _loc3_ = _loc1_[_loc2_];
               _loc4_ = this.var_48.getValue(_loc3_) as IInventoryModel;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         if(this.var_15 != null)
         {
            this.var_15.events.removeEventListener(RoomSessionEvent.const_85,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionEvent.const_97,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_428,this.roomSessionEventHandler);
      ...
      {
         return FurniModel(this.var_48.getValue(InventoryCategory.const_83));
      }
      
      public function get tradingModel() : TradingModel
      {
         return TradingModel(this.var_48.getValue(InventorySubCategory.const_301));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_48.getValue(InventoryCategory.const_664));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_48.getValue(InventoryCategory.const_307));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_48.getValue(InventoryCategory.const_376));
      }
      
      public function get recyclerModel() : RecyclerModel
      {
         return RecyclerModel(this.var_48.getValue(InventorySubCategory.RECYCLER));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(this.var_48.getValue(InventoryCategory.const_150));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_48.getValue(InventoryCategory.const_390) as MarketplaceModel;
      }
      ...
      {
         this.var_376 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_85,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionEvent.const_97,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_428,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_97:
               this.var_1053 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_428:
               this.petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_376 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_167)
         {
            return;
         }
         this._view = new InventoryMainView(this,this._windowManager,this._assetLibrary);
         this._view.setToolbar(this.var_167);
         this.var_48 = new Map();
         ...
         this.var_48.add(InventoryCategory.const_390,_loc1_);
         ...
         this.var_48.add(InventoryCategory.const_83,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_376);
         this.var_48.add(InventoryCategory.const_307,_loc3_);
         ...
         this.var_48.add(InventoryCategory.const_664,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_376);
         this.var_48.add(InventoryCategory.const_376,_loc5_);
         ...
         this.var_48.add(InventorySubCategory.const_301,_loc6_);
         ...
         this.var_48.add(InventorySubCategory.RECYCLER,_loc7_);
         ...
         this.var_48.add(InventoryCategory.const_150,_loc8_);
         this.var_183 = true;
         if(this.var_2528)
         {
            this.requestData();
      ...
      {
         var _loc2_:IInventoryModel = IInventoryModel(this.var_48.getValue(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_48.length)
         {
            _loc3_ = this.var_48.getWithIndex(_loc2_) as IInventoryModel;
            _loc3_.subCategorySwitch(param1);
            _loc2_++;
         }
         switch(param1)
         {
            case InventorySubCategory.const_301:
               this._view.toggleCategoryView(InventoryCategory.const_83,false);
         }
      }
      ...
      public function closingInventoryView() : void
      {
         ...
         {
            _loc2_ = this.var_48.getWithIndex(_loc1_) as IInventoryModel;
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_902.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_902.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_902.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_902.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         var _loc2_:IInventoryModel = this.var_48.getValue(param1) as IInventoryModel;
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1965);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_648));
      }
