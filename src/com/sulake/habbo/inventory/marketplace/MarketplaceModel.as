package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this._controller != null && this._controller.furniModel != null && this.var_218 != null)
         {
            this._controller.furniModel.removeLockFrom(this.var_218.id);
            this.var_218 = null;
         }
      }
      ...
      {
         if(this.var_218 != null || param1 == null)
         {
            return;
         }
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = this.var_218 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,this.var_218.ref));
         this.releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = this.var_218 is FloorItem ? 1 : 2;
         this.var_2087 = _loc2_;
         this.var_2084 = this.var_218.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,this.var_218.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         {
            case 1:
               this._view.showMakeOffer(this.var_218);
               break;
            case 2:
            ...
            case 3:
               ...
               break;
            case 4:
               this._view.showBuyTokens(this.var_1523,this.var_1524);
         }
      }
      ...
      {
         if(param1 != this.var_2087 || param2 != this.var_2084)
         {
            return;
         }
         if(!this._view)
         ...
         this._view.updateAveragePrice(param3,this.var_2085);
      }
