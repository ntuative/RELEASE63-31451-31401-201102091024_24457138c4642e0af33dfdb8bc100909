package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1763:IWindowContainer;
      ...
      private var var_1108:IContainerButtonWindow;
      
      private var var_1107:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1763 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1107 = this.var_1763.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1107)
         {
            this.var_1107.procedure = this.onButtonClick;
         }
         this.var_1108 = this.var_1763.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1108)
         {
            this.var_1108.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_240 >= this._localizations.length - 1)
         {
            this.var_1108.disable();
         }
         else
         {
            this.var_1108.enable();
         }
         if(this.var_240 <= 0)
         {
            this.var_1107.disable();
         }
         else
         {
            this.var_1107.enable();
         }
      }
      ...
      {
         ++this.var_240;
         this.var_240 = Math.min(this.var_240,this._localizations.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_240;
         this.var_240 = Math.max(this.var_240,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this._localizations[this.var_240][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this._localizations[this.var_240][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this._localizations[this.var_240][1]).value;
