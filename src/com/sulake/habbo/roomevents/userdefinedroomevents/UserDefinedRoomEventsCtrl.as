package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1913:TriggerConfs;
      
      private var var_1912:ActionTypes;
      
      private var var_1911:ConditionTypes;
      ...
      private var var_180:UserDefinedRoomEventsHelp;
      
      private var var_1204:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1913 = new TriggerConfs();
         this.var_1912 = new ActionTypes();
         this.var_1911 = new ConditionTypes();
         this.var_264 = new Dictionary();
         super();
         this.var_89 = param1;
         this.var_777 = new RoomObjectHightLighter(param1);
         this.var_180 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_90 = IWindowContainer(this.find(this._window,"configure_container"));
         Util.setProcDirectly(this.find(this.var_90,"save_button"),this.onSave);
         Util.setProcDirectly(this.find(this.var_90,"cancel_save_button"),this.onWindowClose);
         Util.setProcDirectly(this.find(this.var_90,"helplink"),this.onHelp);
         Util.setProcDirectly(this.find(this.var_90,"apply_snapshot_txt"),this.onApplySnapshot);
         this.find(this.var_90,"helplink").mouseThreshold = 0;
         this.find(this.var_90,"apply_snapshot_txt").mouseThreshold = 0;
         this.var_1204 = new SliderWindowController(this.var_89,IWindowContainer(this.find(this.var_90,"delay_slider_container")),this.var_89.assets,0,20,1);
         this.var_1204.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1204.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_777.hideAll(this.var_264);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1204.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_180.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1913);
         this.refreshConfigureElement(this.var_1912);
         this.refreshConfigureElement(this.var_1911);
      ...
      private function refreshConfigureElement(param1:ElementTypeHolder) : void
      {
         ...
         {
            this.find(this.var_90,param1.getKey() + "_icon_bitmap").visible = false;
            return;
         }
         ...
         this.find(this.var_90,"warning_container").visible = false;
         this.refreshConflictingTriggers();
         this.refreshConflictingActions();
         this.refreshActionInputs();
         Util.moveAllChildrenToColumn(this.var_90,3,5);
         this.var_90.height = Util.getLowestPoint(this.var_90) + 1;
      }
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_90,"header_container"));
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.find(this.var_90,"action_inputs_container"));
         if(this.var_60 as ActionDefinition == null)
         {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_90,"warning_container"));
         ...
         _loc3_.height = Util.getLowestPoint(_loc3_) + 4;
         this.find(this.var_90,"warning_container").visible = true;
      }
      
      private function refreshCustomInputs() : void
      {
         var _loc2_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_90.findChildByName("custom_inputs_container"));
      ...
      private function prepareCustomInput() : IWindowContainer
      {
         ...
         var _loc2_:Element = this.resolveType();
         var _loc3_:IWindowContainer = IWindowContainer(this.var_90.findChildByName("custom_inputs_container"));
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_90.findChildByName("select_furni_container"));
         if(!this.isStuffSelectionMode())
         {
            _loc1_.visible = false;
            return;
