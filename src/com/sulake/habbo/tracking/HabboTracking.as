package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_961:uint = 11;
      ...
      private var var_198:IHabboFriendList;
      
      private var var_1200:IHabboWindowManager;
      
      private var var_167:IHabboToolbar;
      
      private var var_180:IHabboHelp;
      ...
      private var var_263:PerformanceTracker = null;
      
      private var var_636:FramerateTracker = null;
      
      private var var_262:LatencyTracker = null;
      
      private var var_635:LagWarningLogger = null;
      
      private var var_634:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_263 = new PerformanceTracker();
         this.var_636 = new FramerateTracker();
         this.var_262 = new LatencyTracker();
         this.var_635 = new LagWarningLogger();
         this.var_634 = new ToolbarClickTracker(this);
         this.var_1467 = new Array(const_961);
         var _loc4_:int = 0;
         while(_loc4_ < const_961)
         {
            this.var_1467[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1566,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1489,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1486,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_649,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1120,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1200)
            {
               this.var_1200.release(new IIDHabboWindowManager());
               this.var_1200 = null;
            }
            if(this.var_278)
            {
            ...
            if(this.var_198)
            {
               ...
               {
                  Component(this.var_198).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_198).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_198).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_198).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_198).events.removeEventListener(HabboFriendListTrackingEvent.const_386,this.onFriendlistTrackingEvent);
               }
               this.var_198.release(new IIDHabboFriendList());
               this.var_198 = null;
            }
            if(this.var_180)
            {
               ...
               {
                  this.var_180.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_180.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_180.release(new IIDHabboHelp());
               this.var_180 = null;
            }
            if(this.var_167)
            {
               ...
               {
                  this.var_167.events.removeEventListener(HabboToolbarEvent.const_39,this.onToolbarClick);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_182)
         {
            if(this.var_262 != null)
            {
               this.var_262.configuration = this.var_182;
            }
            if(this.var_263 != null)
            {
               this.var_263.configuration = this.var_182;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1413);
            if(this.var_182)
            {
               if(this.var_635 != null)
               {
                  this.var_635.configure(this.var_182);
               }
               if(this.var_636 != null)
               {
                  this.var_636.configure(this.var_182);
               }
               if(this.var_634 != null)
               {
                  this.var_634.configure(this.var_182);
               }
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.trackLoginStep(HabboLoginTrackingStep.const_163);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_801,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_267,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_242,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_819,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_67,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_573,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_263 != null)
            {
               this.var_263.connection = param1;
            }
            if(this.var_262 != null)
            {
               this.var_262.communication = this._communication;
               this.var_262.connection = param1;
            }
            if(this.var_635 != null)
            {
               this.var_635.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_819)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1502);
         }
         else if(param1.type == HabboHotelViewEvent.const_573)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1437);
         }
         else if(param1.type == HabboHotelViewEvent.const_67)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1551);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_801:
               this.trackLoginStep(HabboLoginTrackingStep.const_1473,String(this._communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_192:
               ...
               break;
            case HabboCommunicationEvent.const_267:
      ...
      {
         this.var_1200 = IHabboWindowManager(param2);
         if(this.var_1200)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_182)
            {
               if(this.var_182.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1467)
                  {
                  ...
                  if(this.var_263 != null)
                  {
                     _loc4_["null"] = this.var_263.flashVersion;
                     _loc4_["null"] = this.var_263.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1064);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1064,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_198 = param2 as IHabboFriendList;
         Component(this.var_198).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_198).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_198).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_198).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_198).events.addEventListener(HabboFriendListTrackingEvent.const_386,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_386:
      ...
      {
         this.var_180 = param2 as IHabboHelp;
         this.var_180.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_180.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2703)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1362);
            this.var_2703 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1120,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_649,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_280,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_278 = param2 as IAdManager;
         this.var_278.events.addEventListener(AdEvent.const_539,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_167 = param2 as IHabboToolbar;
         this.var_167.events.addEventListener(HabboToolbarEvent.const_39,this.onToolbarClick);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_634)
         {
            this.var_634.track(param1.iconName);
         }
      }
      ...
      {
         this.var_635.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_515 > -1 && _loc2_ < this.var_515)
         {
            ++this.var_1909;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1909);
         }
         if(this.var_515 > -1 && _loc2_ - this.var_515 > 15000)
         {
            ++this.var_1908;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1908);
         }
         this.var_515 = _loc2_;
         if(this.var_263 != null)
         {
            this.var_263.update(param1,this.var_515);
         }
         if(this.var_262 != null)
         {
            this.var_262.update(param1,this.var_515);
         }
         if(this.var_636 != null)
         {
            this.var_636.trackUpdate(param1,this,this.var_515);
         }
         if(this.var_635 != null)
         {
            this.var_635.update(this.var_515);
         }
      }
   }
}
