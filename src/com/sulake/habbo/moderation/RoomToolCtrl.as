package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1125:IDropMenuWindow;
      ...
      private var var_1393:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_34.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_361));
         Logger.log("BEGINNING TO SHOW: " + this.var_361);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_361);
         if(param1.flatId != this.var_361)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_361);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1125 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1125);
         this.var_1125.procedure = this.onSelectTemplate;
         this.var_910 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1394 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1393 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_34,WindowTracker.const_630,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_578 || this.var_478.text == "")
         {
            this.var_34.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_910.isSelected);
         this.var_34.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1582,_loc2_,this.var_478.text,"",""));
         if(this.var_1394.isSelected || this.var_1393.isSelected || this.var_910.isSelected)
         {
            this.var_34.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1394.isSelected,this.var_1393.isSelected,this.var_910.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         ...
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1425);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_34.initMsg.roomMessageTemplates[this.var_1125.selection];
         if(_loc3_ != null)
         {
            this.var_578 = false;
