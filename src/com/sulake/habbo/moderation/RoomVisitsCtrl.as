package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_814:Array = [];
      
      private static var var_1551:int = 200;
      ...
      {
         this.var_672 = IWindowContainer(this.var_34.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1364;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_814.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_672.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_814.length < var_1551)
         {
            ...
            param1.width = this.var_672.width;
            param1.height = this.var_672.height;
            var_814.push(param1);
         }
         else
         {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1270)
         {
