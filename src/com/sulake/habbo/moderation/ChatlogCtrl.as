package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_879:Array = [];
      
      private static var var_1724:int = 1000;
      
      private static var var_880:Array = [];
      
      private static var var_1726:int = 200;
      ...
      private var var_1725:IMessageComposer;
      ...
      {
         this.var_721 = IWindowContainer(this.var_34.getXmlWindow("chatlog_roomheader"));
         this.var_722 = IWindowContainer(this.var_34.getXmlWindow("chatlog_chatline"));
         ...
         this.var_34.connection.send(this.var_1725);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_879.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_722.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_879.length < var_1724)
         {
            ...
            param1.width = this.var_722.width;
            param1.height = this.var_722.height;
            var_879.push(param1);
         }
         else
         {
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_880.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_721.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_880.length < var_1726)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_721.width;
            param1.height = this.var_721.height;
            var_880.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1727[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1349.getValue(param2.chatterName))
            {
               this.var_1349.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1349.getValue(_loc2_);
