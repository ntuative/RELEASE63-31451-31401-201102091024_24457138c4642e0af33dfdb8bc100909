package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1964:String = "my_issues";
      
      private const const_1963:String = "open_issues";
      
      private const const_1962:String = "picked_issues";
      
      private const const_1990:String = "closed_issues";
      ...
      private var var_343:IIssueBrowserView;
      
      private var var_1758:IIssueBrowserView;
      
      private var var_1760:IIssueBrowserView;
      
      private var var_1759:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_239 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_239.numTabItems)
            {
               _loc5_ = this.var_239.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_59,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_239 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_239 == null || this.var_239.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_239.selector.getSelectableByName("open_issues");
         this.var_239.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_343 == _loc2_)
         {
            return;
         }
         if(this.var_343 != null)
         {
            this.var_343.visible = false;
         }
         this.var_343 = _loc2_;
         if(this.var_343 == null)
         {
         ...
         this.var_343.view.width = this.var_239.container.width;
         this.var_343.view.height = this.var_239.container.height;
         this.var_343.visible = true;
         this.var_343.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1964:
               ...
               {
                  this.var_1758 = new MyIssuesView(this.issueManager,this,this.var_239.container);
               }
               return this.var_1758;
            case this.const_1963:
               if(this.var_1760 == null)
               {
                  this.var_1760 = new OpenIssuesView(this.issueManager,this,this.var_239.container);
               }
               return this.var_1760;
            case this.const_1962:
               if(this.var_1759 == null)
               {
                  this.var_1759 = new PickedIssuesView(this.issueManager,this,this.var_239.container);
               }
