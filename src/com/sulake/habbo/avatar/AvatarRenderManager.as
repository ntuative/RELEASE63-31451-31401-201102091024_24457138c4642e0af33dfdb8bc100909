package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1954:String = "hd-99999-99999";
      ...
      private var var_295:PetDataManager;
      
      private var var_704:PaletteManager;
      
      private var var_531:String;
      
      private var var_294:Map;
      
      private var var_206:AvatarAssetDownloadManager;
      
      private var var_1672:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_531 = RenderMode.const_1516;
         ...
         this.var_96.add(AvatarType.const_70,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_295 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_704 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_295.populateFigureData(_loc5_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_206)
         {
            this.var_206.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         _loc2_ = this.var_96.getValue(AvatarType.const_70) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(this.var_206 == null)
               {
                  ...
                  this.var_206 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_206.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_819)
         {
            if(this.var_2376 && this.var_2377 && this.var_2378)
            {
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_206.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_206.loadFigureSetData(param1,param2);
      }
      ...
      public function createAvatarImage(param1:String, param2:String, param3:String = null, param4:IAvatarImageListener = null) : IAvatarImage
      {
         ...
         if(this.var_206.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1672)
         {
            this.var_1672 = new AvatarFigureContainer(this.const_1954);
         }
         this.var_206.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1672,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 == null || this.var_294 == null)
         {
            return;
         }
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_294.getKeys())
         {
            _loc4_ = this.var_294.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_295.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1499)
         {
            _loc6_ = !this.var_295.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_295.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_96.getValue(AvatarType.const_70) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_294.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_295.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_96.getValue(AvatarType.const_70);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_294.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_294.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         return this.var_295 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_70:
               _loc3_ = this.var_96.getValue(AvatarType.const_70) as AvatarStructure;
               break;
            default:
