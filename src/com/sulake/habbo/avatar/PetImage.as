package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_234:AvatarImageCache;
      ...
      private var var_528:IAvatarDataContainer;
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_633);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_633);
                  _loc20_ = this.var_85;
                  _loc21_ = 1;
                  switch(this.var_85)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_633);
            if(_loc10_ != null)
            {
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_633);
                  _loc21_ = this.var_85;
                  _loc22_ = 1;
                  switch(this.var_85)
                  {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_513 = this.var_513 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_341:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1550:
                  case AvatarAction.const_1494:
                  case AvatarAction.const_1386:
                  case AvatarAction.const_1068:
                  case AvatarAction.const_995:
                  case AvatarAction.const_1615:
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_308.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_896);
         this.getCache().resetBodyPartCache(this.var_896);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1375 = this._structure.sortActions(this.var_308);
         ...
         {
            this.var_770 = this._structure.getCanvasOffsets(this.var_1375,this._scale,this.var_85);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1375)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_216)
               {
                  this.var_892 = true;
               }
