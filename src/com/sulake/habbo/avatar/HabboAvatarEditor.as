package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1237:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1236:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1013:AvatarEditorHandler;
      ...
      private var var_820:IFigureData;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_183)
         {
            ...
            this.var_544["null"] = new FigureData(this);
            this.var_544["null"] = new FigureData(this);
            _loc2_ = this.var_544["null"];
            _loc3_ = this.var_544["null"];
            _loc2_.loadAvatarData(const_1237,FigureData.const_74);
            _loc3_.loadAvatarData(const_1236,FigureData.FEMALE);
            this.var_94 = new Map();
            this.var_454 = new Map();
            this.var_94.add(AvatarEditorFigureCategory.const_810,new BodyModel(this));
            this.var_94.add(AvatarEditorFigureCategory.const_47,new HeadModel(this));
            this.var_94.add(AvatarEditorFigureCategory.const_238,new TorsoModel(this));
            this.var_94.add(AvatarEditorFigureCategory.const_847,new LegsModel(this));
            ...
            this.var_454.add(AvatarEditorSideCategory.const_102,new WardrobeModel(this));
            this.var_454.add(AvatarEditorSideCategory.const_489,new ClubPromoModel(this));
            this.var_183 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_544[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_820.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_820.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_810);
         }
      ...
      {
         this.var_820 = this.var_453.getFigureData(AvatarType.const_112);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1013 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_544[this.var_964];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1276 != null)
         {
            ...
            this.var_1276.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1558;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1012 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1235)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1471.clone() as IWindowContainer,param1,_loc13_);
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1210.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1552)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1012 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1210.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1012 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_454.getValue(AvatarEditorSideCategory.const_102);
      }
