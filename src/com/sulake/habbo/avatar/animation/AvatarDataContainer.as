package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         this.var_1575 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2185 = parseInt(_loc2_,16);
         this.var_2184 = parseInt(_loc3_,16);
         ...
         this.var_1663 = new ColorTransform(this.var_1700,this.var_1699,this.var_1701,this._alphaMultiplier);
         this.var_1024 = this.generatePaletteMapForGrayscale(this.var_2184,this.var_2185);
      }
      ...
      {
         return this.var_1024.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1024.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1024.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1024.getValue("alphas") as Array;
      }
