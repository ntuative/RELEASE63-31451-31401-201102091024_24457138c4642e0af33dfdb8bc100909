package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1210:IWindowContainer;
      
      public static var var_1471:IWindowContainer;
      
      public static var var_1934:int = 6710886;
      ...
      private var var_492:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_491:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1127 = [];
         this.var_1290 = [AvatarEditorFigureCategory.const_810,AvatarEditorFigureCategory.const_47,AvatarEditorFigureCategory.const_238,AvatarEditorFigureCategory.const_847,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_102];
         super();
         ...
         if(var_1210 == null)
         {
            ...
            var_1210 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1471 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1471 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_414 = new Timer(1000);
         this.var_414.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1290;
         }
         for each(_loc6_ in param4)
         {
            this.var_1127.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_414.stop();
            this.var_414.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_414 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1290);
         }
         if(param1.length != this.var_1127.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1127.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2560 = this.canChangeOutfit();
            this.var_414.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_492 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_492.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_492.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1127.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_492.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_492.numSelectables)
               {
                  this.var_492.getSelectableAt(_loc6_).x = this.var_492.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1290;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1796 == AvatarEditorSideCategory.const_102 || this.var_2561))
         {
         ...
         this.setViewToCategory(this.var_316);
      }
      ...
      {
         if(this.var_1796 == AvatarEditorSideCategory.const_102)
         {
            this.var_2561 = false;
            this.setSideContent(AvatarEditorSideCategory.const_889);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_889:
               break;
            case AvatarEditorSideCategory.const_489:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_489);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_316 = param1;
         this.var_492.setSelected(this.var_492.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_491)
         {
            ...
            this.var_491 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_491.procedure = this.stripClubDialogEventProc;
            this.var_491.center();
         }
         else
         {
