package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageDirectionCache
   {
      ...
      {
         var _loc2_:String = this.method_4(param1);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:String = this.method_4(param2);
      ...
      private function method_4(param1:int) : String
      {
         var _loc3_:* = null;
         var _loc2_:* = "";
         for each(_loc3_ in this.var_1917)
         {
