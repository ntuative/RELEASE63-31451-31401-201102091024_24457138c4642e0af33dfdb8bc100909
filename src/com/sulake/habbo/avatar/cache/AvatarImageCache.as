package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1666:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1429:IAvatarImage;
      ...
      private var var_327:IActiveActionData;
      
      private var var_384:AvatarImageBodyPartContainer;
      ...
      private var var_2243:ByteArray;
      
      private var var_2244:ImageData;
      
      private var var_909:PaletteMap;
      
      private var var_838:Array;
      
      private var var_837:Point;
      ...
      {
         if(this.var_682 == param1)
         {
            return;
         }
         if(this.var_682 == GeometryType.const_973 && param1 == GeometryType.const_1065 || this.var_682 == GeometryType.const_1065 && param1 == GeometryType.const_973)
         {
            this.var_682 = param1;
            this.var_83 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         this.var_327 = this._bodyPartCache.getAction();
         var _loc5_:IActiveActionData = this.var_327;
         var _loc6_:* = [];
         var _loc7_:Dictionary = new Dictionary();
         var _loc8_:Point = new Point();
         if(!(!this.var_327 || !this.var_327.definition))
         {
            if(this.var_327.definition.isAnimation)
            {
               _loc11_ = _loc3_;
               _loc12_ = this._structure.getAnimation(this.var_327.definition.state + "." + this.var_327.actionParameter);
               _loc13_ = param2 - this.var_327.startFrame;
               if(_loc12_ != null)
               {
                  _loc14_ = _loc12_.getLayerData(_loc13_,param1,this.var_327.overridingAction);
                  if(_loc14_ != null)
                  {
                     ...
                     {
                        this.var_327 = _loc14_.action;
                     }
                     if(_loc14_.type == AnimationLayerData.const_656)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_445)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1429.getFigure(),_loc5_,this.var_682,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_384 = _loc10_.getImageContainer(_loc4_);
         if(this.var_384 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_384 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_327);
            if(this.var_384 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_384,_loc4_);
         }
         this.var_384.offset = _loc8_;
         return this.var_384;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_83)
         {
            this.var_83 = this._structure.getCanvas(this._scale,this.var_682);
            if(!this.var_83)
            {
               return null;
            }
            this.var_2245 = new Point(0,this.var_83.height - int(this.var_83.width / 4));
         }
         ...
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_697 || _loc10_ == AvatarAction.const_353;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1300 = this.var_107.bodyPartId;
               this.var_165 = this.var_107.partType;
               this.var_1595 = this.var_107.partId;
               ...
               this.var_1299 = this._scale + "_" + this.var_107.action.assetPartDefinition + "_" + this.var_165 + "_" + this.var_1595 + "_" + _loc5_ + "_" + this._frame;
               this.var_386 = this._assets.getAssetByName(this.var_1299) as BitmapDataAsset;
               if(this.var_386 == null)
               {
                  this.var_1299 = this._scale + "_std_" + this.var_165 + "_" + this.var_1595 + "_" + _loc5_ + "_0";
                  this.var_386 = this._assets.getAssetByName(this.var_1299) as BitmapDataAsset;
               }
               if(!(!this.var_386 || !this.var_386.content))
               {
                  ...
                  {
                     this.var_909 = this._structure.renderManager.paletteManager.getPalette(this.var_107.paletteMapId);
                     if(this.var_909 != null)
                     {
                        this.var_839 = this.var_386.content as BitmapData;
                        this.var_166 = new BitmapData(this.var_839.width,this.var_839.height);
                        this.var_2243 = this.var_909.colorize(this.var_839.getPixels(this.var_839.rect));
                        this.var_166.setPixels(this.var_166.rect,this.var_2243);
                     }
                     else
                     {
                  ...
                  if(_loc11_ && (this.var_1300 == AvatarBodyPartType.const_238 || this.var_1300 == AvatarBodyPartType.const_1351 || this.var_1300 == AvatarBodyPartType.const_1452) && this.var_107.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  this.var_837 = this.var_386.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_54)
                     {
                  ...
                  this.var_2244 = new ImageData(this.var_166,this.var_837,_loc7_);
                  this.var_838.push(this.var_2244);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_838,_loc6_);
         ...
         _loc8_ = this.var_838.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_838.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
