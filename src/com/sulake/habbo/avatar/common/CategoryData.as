package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_1991:int = 2;
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         this.var_213 = new Array(param1.length);
         var _loc3_:int = 0;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_903 >= 0 && this._parts.length > this.var_903)
         {
            _loc2_ = this._parts[this.var_903];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         this.deselectColorIndex(this.var_213[param2],param2);
         this.var_213[param2] = param1;
      ...
      public function getSelectedColorIds() : Array
      {
         var _loc7_:* = null;
         var _loc8_:* = null;
         if(!this.var_213 || this.var_213.length == 0)
         {
            return null;
         }
         ...
         var _loc5_:int = 0;
         while(_loc5_ < this.var_213.length)
         {
            _loc7_ = this.var_244[_loc5_];
            if(!(!_loc7_ || _loc7_.length <= _loc5_))
            {
               if(_loc7_.length > this.var_213[_loc5_])
               {
                  _loc8_ = _loc7_[this.var_213[_loc5_]] as AvatarEditorGridColorItem;
      ...
      private function getSelectedColors() : Array
      {
         ...
         var _loc3_:int = 0;
         while(_loc3_ < this.var_213.length)
         {
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= this.var_213[param1])
         {
            return null;
         }
         return _loc2_[this.var_213[param1]] as AvatarEditorGridColorItem;
      }
      ...
      {
         return this._parts[this.var_903] as AvatarEditorGridPartItem;
      }
