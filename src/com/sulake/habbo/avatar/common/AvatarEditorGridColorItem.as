package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_923:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_661.width,this.var_661.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_661,this.var_661.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1129.width,this.var_1129.height,true,0);
            _loc5_ = this.var_1129.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_923.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_922.width,this.var_922.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_922,this.var_922.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(_loc4_)
         {
            if(this.var_923)
            {
               switch(this.var_923.clubLevel)
               {
                  case HabboClubLevelEnum.const_50:
                     _loc4_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_60:
                     _loc4_.style = HabboIconType.const_699;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_55:
                     _loc4_.style = HabboIconType.const_637;
                     _loc4_.visible = true;
               }
            }
            else
