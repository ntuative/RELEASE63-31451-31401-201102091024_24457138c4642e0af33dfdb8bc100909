package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1306:String = "Default";
      
      private static const const_1308:int = 2;
      
      private static const const_1307:String = AvatarSetType.const_34;
      ...
      protected var var_1983:int;
      
      protected var var_269:IActiveActionData;
      
      protected var var_737:Boolean;
      
      protected var var_770:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_234:AvatarImageCache;
      
      protected var var_630:AvatarFigureContainer;
      
      protected var var_528:IAvatarDataContainer;
      
      protected var var_308:Array;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_630 = param3;
         this.var_234 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1307,const_1308);
         this.var_308 = new Array();
         this.var_896 = new ActiveActionData(AvatarAction.const_388);
         this.var_896.definition = this._structure.getActionDefinition(const_1306);
         this.resetActions();
      ...
      {
         param2 += this.var_1767;
         if(param2 < AvatarDirectionAngle.const_966)
         {
            param2 = AvatarDirectionAngle.const_319 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_319)
         {
            param2 -= NaN;
         }
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_633,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_260.length == 1 && this.var_85 == this.var_1983)
         {
            return this.var_85 + this.var_513 + this.var_633 % 4;
         }
         if(this.var_260.length == 2)
         {
            for each(_loc1_ in this.var_260)
            {
               ...
               {
                  return this.var_85 + this.var_513 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_633 % 11;
                  return this.var_85 + "_" + this.var_1983 + this.var_513 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2700 || param2 != this.var_2699 || param1 != this.var_2701)
         {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1233 || this.var_43 == null || (this.var_43.width != _loc5_.width || this.var_43.height != _loc5_.height))
         {
            if(this.var_43 != null && !this.var_1233)
            {
               this.var_43.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_269.definition.geometryType,this.var_85);
         this.var_43.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_633);
         ...
         {
            if(this.var_528.paletteIsGrayscale)
            {
               ...
               this.var_43 = _loc13_;
               this.var_43.paletteMap(this.var_43,this.var_43.rect,new Point(0,0),this.var_528.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_269.definition.geometryType,this.var_85);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_633);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_308.push(new ActiveActionData(param1,param2,this.var_633));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_269 = this.var_896;
         this.var_269.definition = this.var_896.definition;
         this.resetBodyPartCache(this.var_896);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_513 = "";
         this.var_260 = this._structure.sortActions(this.var_308);
         if(this.var_260 == null)
         {
            this.var_770 = new Array(0,0,0);
            if(this.var_1463 != "")
            {
               _loc1_ = true;
               this.var_1463 = "";
         ...
         {
            this.var_770 = this._structure.getCanvasOffsets(this.var_260,this._scale,this.var_85);
            for each(_loc4_ in this.var_260)
            {
               this.var_513 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_315)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1464 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1464 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1463 != this.var_513)
            {
               _loc1_ = true;
               this.var_1463 = this.var_513;
            }
         }
         this.var_1376 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_260)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_892 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1767 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_528 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_283 || _loc1_.actionType == AvatarAction.const_216 || _loc1_.actionType == AvatarAction.const_353)
               {
                  this.var_892 = true;
               }
            }
      ...
      public function get method_12() : IAvatarDataContainer
      {
         return this.var_528;
      }
