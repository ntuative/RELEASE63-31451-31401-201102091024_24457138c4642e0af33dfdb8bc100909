package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_849:TraxSequencer;
      
      private var var_559:PlayListController;
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_850.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            ...
            this.var_850.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_464;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_558.add(_loc4_,param1);
      }
      ...
      public function loadTraxSong(param1:int, param2:String) : IHabboSound
      {
         ...
         var _loc5_:* = [];
         var _loc6_:Array = this.var_685.getKeys();
         var _loc7_:int = 0;
         ...
         var _loc8_:TraxSequencer = new TraxSequencer(param1,_loc3_,this.var_685,events);
         _loc8_.volume = this.var_464;
         this.var_849 = null;
         this.var_684 = -1;
         if(_loc5_.length != 0)
         {
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_848.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_848 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_182 == null || this._connection == null || this._roomEngine == null || this.var_559 != null)
         {
            return;
         }
         this.var_559 = new PlayListController(this,events,this._roomEngine.events,this._connection);
      }
      
      private function onSampleLoadComplete(param1:Event) : void
      {
         var _loc2_:Sound = param1.target as Sound;
         var _loc3_:int = this.var_558.getValue(_loc2_);
         ...
         this.var_558.remove(_loc2_);
         this.var_685.add(_loc3_,_loc6_);
         if(this.var_558.length == 0 && this.var_684 != -1)
         {
            this.var_849.ready = true;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1105,this.var_684));
            this.var_684 = -1;
            this.var_849 = null;
         }
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_559.checkSongPlayState(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1357,this.var_684));
         this.var_684 = -1;
         this.var_849 = null;
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIconState(this.var_464 > 0);
            return;
         }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_464 * 100)));
         }
      }
      ...
      {
         this.var_464 = param1;
         this.var_559.updateVolume(this.var_464);
      ...
      private function setHabboToolbarIconState(param1:Boolean) : void
      {
         ...
         this.var_167.events.dispatchEvent(_loc2_);
      }
   }
}
