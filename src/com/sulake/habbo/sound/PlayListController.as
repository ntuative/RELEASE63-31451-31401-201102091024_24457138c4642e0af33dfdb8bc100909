package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1961:String = "type_sound_machine";
      
      private const const_1681:String = "type_jukebox";
      
      private var var_610:HabboSoundManagerFlash10;
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_845,this.onSongFinishedPlayingEvent);
         this.var_89.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_818,this.onSoundMachinePlayEvent);
         this.var_89.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_794,this.onSoundMachineStopEvent);
         this.var_89.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_692,this.onJukeboxInitEvent);
         this.var_89.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_441,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_845,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_89)
            {
               this.var_89.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_818,this.onSoundMachinePlayEvent);
               this.var_89.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_794,this.onSoundMachineStopEvent);
               this.var_89.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_692,this.onJukeboxInitEvent);
               this.var_89.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_441,this.onDisposeEvent);
               this.var_89 = null;
            }
            if(this.var_405)
            {
      ...
      {
         this.startPlaying(this.const_1961);
      }
      ...
      public function startPlaying(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_298 = _loc2_.id;
            this.playSong(this.var_298);
         }
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_405[this.var_298] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_405.getValue(this.var_298) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         var _loc6_:* = null;
         this.var_298 = param1;
         var _loc2_:IHabboSound = this.var_405.getValue(param1) as IHabboSound;
         if(_loc2_ == null)
         {
         ...
         _loc2_.volume = this.var_610.volume;
         _loc2_.play();
         if(_loc3_.length >= 4)
         {
            this.var_610.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
         var _loc5_:PlayListEntry = this.getNextEntry();
         if(_loc5_ != null && _loc5_.id != this.var_298)
         {
            _loc6_ = this.var_405[_loc5_.id] as IHabboSound;
            if(_loc6_ == null)
            {
      ...
      {
         if(this.var_1734 == this.const_1681)
         {
            this.var_75.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_)
         {
            _loc7_ = this.var_405[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_610.loadTraxSong(_loc3_.id,_loc3_.data);
               this.var_405.add(_loc3_.id,_loc7_);
            }
