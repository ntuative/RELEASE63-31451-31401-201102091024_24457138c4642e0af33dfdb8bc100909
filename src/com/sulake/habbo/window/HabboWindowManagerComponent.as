package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1297:uint = 1;
      ...
      private var var_887:IWindowRenderer;
      
      private var var_860:ISkinContainer;
      
      private var var_342:Array;
      
      private var var_1362:IEventDispatcher;
      
      private var var_1096:Boolean = false;
      
      private var var_1748:ProfilerOutput;
      
      private var var_1364:ProfilerAgentTask;
      
      private var var_1363:ProfilerAgentTask;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         FontEnum.refresh();
         _instance = this;
         this.var_1362 = param1.events;
         this.var_342 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_860 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_887 = new WindowRenderer(this.var_860);
         this.var_192 = new Array(const_409);
         ...
         {
            this.var_192[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_887,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this._windowContext = this.var_192[const_1297];
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_346,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1432,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1748)
            {
               this.var_1748 = new ProfilerOutput(context,this,this.var_887);
            }
            this.var_1748.profiler = _loc3_;
            this.var_1364 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1364);
            this.var_1363 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1363);
            this.var_1096 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_192)
            {
               ...
               {
                  IDisposable(this.var_192.pop()).dispose();
               }
            }
            this.var_192 = null;
            if(this.var_342)
      ...
      {
         var _loc3_:Dictionary = this.var_342[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_342[0][param1] as XML : _loc4_;
      }
      
      public function getDefaultsByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         return this.var_860.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this.var_192[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_192[param2].getDesktopWindow();
      ...
      {
         return this.var_192[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_192[param1].getDesktopWindow().getChildAt(this._windowContext.getDesktopWindow().numChildren - 1);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_192[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_369.length > 0)
         {
            this.var_1362.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_409 - 1;
            while(_loc2_ >= 0)
            {
               this.var_192[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1096)
         ...
         this.var_1362.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_409)
         {
            this.var_192[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1096)
         {
         ...
         if(WindowContext.var_369.length > 0)
         {
            WindowContext.var_369.flush();
         }
         this.var_1362.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1608,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1612,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1553,param2.name + ": " + param2.toString());
            }
         }
      }
      ...
      private function performTestCases() : void
      {
         ...
         _loc1_.begin(this);
         _loc1_.test({
            "type":WindowType.const_505,
            "style":WindowStyle.const_175,
            "caption":"Testing",
            "count":800,
            "properties":[_loc2_]
         });
