package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_49:IHabboCommunicationManager;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_15:IRoomSessionManager;
      
      private var var_498:IKeyExchange;
      
      private var var_933:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2581:PseudoRandom;
      ...
      private var var_214:HabboHotelView;
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_605 = param1;
            this.var_49.initConnection(HabboConnectionType.const_224);
         }
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            this.var_49 = param2 as IHabboCommunicationManager;
            _loc3_ = this.var_49.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            this.var_49.addHabboConnectionMessageEvent(new HelloMessageEvent(this.onHelloEvent));
            this.var_49.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(this.onInitCrypto));
            this.var_49.addHabboConnectionMessageEvent(new SecretKeyEvent(this.onSecretKeyEvent));
            this.var_49.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(this.onSessionParamsEvent));
            this.var_49.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            this.var_49.addHabboConnectionMessageEvent(new StartRegistrationEvent(this.onStartRegistration));
            this.var_49.addHabboConnectionMessageEvent(new PingMessageEvent(this.onPing));
            this.var_49.addHabboConnectionMessageEvent(new ErrorReportEvent(this.onErrorReport));
            this.var_49.addHabboConnectionMessageEvent(new UserObjectEvent(this.onUserObject));
            this.var_49.addHabboConnectionMessageEvent(new GenericErrorEvent(this.onGenericError));
            this.var_49.addHabboConnectionMessageEvent(new DisconnectReasonEvent(this.onDisconnectReason));
            this.var_49.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(this.onRoomEntryInfoEvent));
            this.var_49.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(this.onUniqueMachineId));
            this.var_49.addHabboConnectionMessageEvent(new IdentityAccountsEvent(this.onIdentityAccounts));
            this.checkRequirements();
         }
      }
      ...
      {
         if(this.var_49 && this.var_130 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_214 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         var _loc1_:String = this.var_130.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_130.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_214.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_130.getKey("use.sso.ticket") == "1";
         this.var_605 = this.var_130.getKey("sso.ticket",null);
         this.var_1816 = this.var_130.getKey("flash.client.url","");
         this.var_2580 = this.var_130.getKey("external.variables.txt","");
         if(this.var_214 == null)
         {
            this.var_214 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_49.mode = HabboConnectionType.const_117;
            if(this.var_605)
            {
               this.var_49.initConnection(HabboConnectionType.const_224);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_429,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         {
            this.var_49.mode = HabboConnectionType.const_117;
            if(this.var_130.keyExists("local.environment"))
            {
               this.var_49.mode = HabboConnectionType.const_1034;
            }
         }
         this.var_49.initConnection(HabboConnectionType.const_224);
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = this.var_49.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_801);
            _loc3_ = new InitCryptoMessageComposer(this.var_49.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2581 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_49.mode)
         {
            case HabboConnectionType.const_117:
               _loc6_ = "";
               _loc6_ = this.var_130.getKey("url.prefix",_loc6_);
               _loc6_ = _loc6_.replace("http://","");
               _loc6_ = _loc6_.replace("https://","");
               _loc7_ = this.var_130.getKey("hotelview.banner.url","http:/\nsitename$/gamedata/banner");
               _loc7_ = _loc7_.replace("$sitename$",_loc6_);
               this.var_1417 = _loc4_;
               this.var_214.loadBannerImage(_loc7_ + "?token=" + this.var_1417,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1034:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1601:
               this.var_933 = this.generateRandomHexString(30);
               this.var_498 = new DiffieHellman(new BigInteger(this.var_130.getKey("connection.development.prime"),16),new BigInteger(this.var_130.getKey("connection.development.generator"),16));
               this.var_498.init(this.var_933);
               _loc8_ = this.var_498.method_5(10);
               _loc2_.send(new GenerateSecretKeyMessageComposer(_loc8_.toUpperCase()));
               break;
            default:
               Logger.log("[HabboCommunicationDemo] Unknown Connection Mode: " + this.var_49.mode);
         }
      }
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_498.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_498.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2581);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1816,this.var_2580));
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_605 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_605);
            _loc2_.send(_loc4_);
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_192);
         }
      ...
      {
         var _loc4_:IConnection = this.var_49.getHabboMainConnection(null);
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_267);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2582)
         {
            _loc2_ = this.var_130.getKey("logout.disconnect.url");
            if(this.var_130.keyExists("facebook.user"))
            {
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         this.var_2582 = true;
         var _loc2_:String = this.var_130.getKey("logout.url");
         if(_loc2_.length > 0)
         {
      ...
      private function setOriginProperty(param1:String) : String
      {
         ...
         {
            return param1.replace("%origin%",this.var_130.getKey("flash.client.origin","popup"));
         }
         return param1;
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1417);
         ...
         var _loc9_:IConnection = this.var_49.getHabboMainConnection(null);
         ...
         this.var_498 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_498.init(_loc14_);
            _loc15_ = this.var_498.method_5(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_933 = _loc14_;
            }
