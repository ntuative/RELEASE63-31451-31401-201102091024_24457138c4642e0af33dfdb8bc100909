package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      private var var_224:IFrameWindow;
      ...
      private function onQuestCompletedRewardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_224.findChildByName("reward.currency.icon") as IBitmapWrapperWindow;
      ...
      {
         this.var_224 = IFrameWindow(this.var_63.controller.questEngine.getXmlWindow("QuestCompletedDialog"));
         this.var_224.findChildByTag("close").procedure = this.onCompletedDialogClose;
         this.var_224.center();
         var _loc2_:IWindow = this.var_224.findChildByName("button.catalog");
         if(_loc2_)
         {
         ...
         this.var_224.caption = "${quest.completed}";
         this.var_224.findChildByName("reward.description").caption = "${" + _loc3_ + ".completed.reward}";
         ...
         this.var_224.findChildByName("description").caption = this.var_63.controller.questEngine.localization.getKey(_loc4_ + ".completed.desc");
         this.var_224.findChildByName("reward.currency.desc").caption = this.var_63.controller.questEngine.localization.getKey(_loc3_ + ".completed.currency");
         var _loc5_:String = "icon_" + this.var_63.code + "_reward_" + param1.rewardCurrencyAmount;
         var _loc6_:IBitmapWrapperWindow = this.var_224.findChildByName("reward.currency.icon") as IBitmapWrapperWindow;
