package com.sulake.habbo.quest
{
   ...
   public class QuestCampaign implements IDisposable
   {
      ...
      private var var_505:Quest;
      
      private var var_303:QuestView;
      ...
      private var var_304:IItemListWindow;
      ...
      public function QuestCampaign(param1:QuestController, param2:String)
      {
         ...
         this.var_180 = new QuestHelp(this);
      }
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_764)
         {
            _loc1_.dispose();
         }
         this.var_764 = [];
      ...
      private function reset() : void
      {
         ...
         if(this.var_357)
         {
            ...
            {
               this.var_304.removeListItem(_loc1_.view);
               _loc1_.dispose();
            }
            this.var_357 = null;
            this.var_304.destroyListItems();
            this.var_304.removeListItems();
         }
         this.var_505 = null;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1171 = this._window.findChildByName("quest.container") as IWindowContainer;
         this.var_1445 = this._window.findChildByName("currency.container") as IWindowContainer;
         this.var_304 = this._window.findChildByName("quests") as IItemListWindow;
         ...
         this.var_1445.findChildByName("currency.amount").caption = "${quest_" + this.var_1866 + ".currency}";
         var _loc3_:String = "quest_" + this.code;
         var _loc4_:* = _loc3_ + ".title";
         var _loc5_:* = _loc3_ + ".currency";
         this.setText("currency.amount",_loc5_);
         this.var_1172 = this._window.findChildByName("help.button") as IWindowContainer;
         if(this.var_1172)
         {
            this.var_1172.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.helpButtonEventProc);
            this.var_1172.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.helpButtonEventProc);
            this.var_1172.addEventListener(WindowMouseEvent.const_25,this.helpButtonEventProc);
         }
      }
      ...
      private function openHelp() : void
      {
         ...
         if(this.var_505)
         {
            this.var_505.selected = false;
         }
         if(this.var_180)
         {
            this.var_1171.addChild(this.var_180.view);
         }
      }
      
      public function updatePurse() : void
      {
         var _loc1_:int = this._controller.questEngine.getActivityPointsForType(this.var_1697);
      ...
      public function openCampaign(param1:Array) : void
      {
         ...
         {
            this.var_357.push(new Quest(_loc2_,this));
         }
         _loc3_ = null;
         for each(_loc4_ in this.var_357)
         {
            this.var_304.addListItem(_loc4_.view);
            if(!_loc3_ && (_loc4_.status == QuestStatusEnum.const_44 || _loc4_.status == QuestStatusEnum.const_470))
            {
               _loc3_ = _loc4_;
            }
         }
         if(_loc3_)
         {
            ...
            if(this.var_304.maxScrollV > 0)
            {
               this.var_304.scrollV = _loc3_.view.y / this.var_304.maxScrollV;
            }
         }
         else if(this.var_357.length > 0)
         {
            this.activateListItem(this.var_357[0]);
         }
      }
      ...
      public function activateListItem(param1:Quest) : void
      {
         ...
         this.var_505 = param1;
         this.var_505.selected = true;
         this.showQuestData(this.var_505);
      }
      ...
      private function showQuestData(param1:Quest) : void
      {
         ...
         this.var_303 = new QuestView(this,param1);
         this.var_1171.addChild(this.var_303.view);
         this.var_303.init();
      }
      ...
      {
         this.modifyQuestData(param1);
         this.var_764.push(new QuestCompleted(this,param1));
      }
      ...
      public function closeQuestCompleted(param1:QuestCompleted) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         for each(_loc3_ in this.var_764)
         {
            if(_loc3_ == param1)
            {
               _loc2_ = _loc3_;
         ...
         {
            _loc2_.dispose();
            _loc4_ = this.var_764.indexOf(_loc2_);
            if(_loc4_ >= 0)
            {
               this.var_764.splice(_loc4_,1);
            }
         }
      }
      ...
      private function modifyQuestData(param1:QuestMessageData) : void
      {
         ...
         if(_loc2_)
         {
            ...
            this.var_357[_loc3_] = _loc5_;
            _loc6_ = this.var_304.getListItemIndex(_loc2_.view);
            this.var_304.removeListItem(_loc2_.view);
            if(_loc6_ > -1)
            {
               this.var_304.addListItemAt(_loc5_.view,_loc6_);
            }
            else
            {
               this.var_304.addListItem(_loc5_.view);
            }
            if(this.var_505 == _loc2_)
            {
