package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_297:MainViewCtrl;
      
      private var var_577:RoomInfoViewCtrl;
      
      private var var_1081:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_391:Tabs;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_2791:Dictionary;
      ...
      private var var_2423:RoomThumbnailRenderer;
      
      private var var_958:GuestRoomPasswordInput;
      
      private var var_362:GuestRoomDoorbell;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_297 = new MainViewCtrl(this);
         this.var_577 = new RoomInfoViewCtrl(this);
         this.var_1081 = new RoomCreateViewCtrl(this);
         this.var_2423 = new RoomThumbnailRenderer(this);
         this.var_958 = new GuestRoomPasswordInput(this);
         this.var_362 = new GuestRoomDoorbell(this);
         this.var_391 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_270,HabboWindowStyle.const_40,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_577.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_167.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_116,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_167.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_116,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_167.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      {
         var _loc1_:Boolean = this.var_297.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_297.startSearch(Tabs.const_264,Tabs.const_393,param1);
         this.var_297.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_297.startSearch(Tabs.const_298,Tabs.const_254);
         this.var_391.getTab(Tabs.const_298).tabPageDecorator.tabSelected();
      }
