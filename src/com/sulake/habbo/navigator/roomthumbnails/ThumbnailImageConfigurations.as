package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfigurations
   {
      ...
      private var var_1654:Dictionary;
      
      private var var_1655:Dictionary;
      ...
      public function ThumbnailImageConfigurations(param1:HabboNavigator)
      {
         ...
         this.var_1655 = new Dictionary();
         super();
         this._navigator = param1;
         this.var_1869 = this._navigator.getButtonImage("rico_selected");
      ...
      {
         var _loc4_:ThumbnailImageConfiguration = new ThumbnailImageConfiguration(this._navigator,param1,param2,param3,this.var_1869);
      ...
      {
         var _loc2_:Dictionary = this.var_1655[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1655[param1] = _loc2_;
         }
         return _loc2_;
      }
      ...
      {
         var _loc2_:Array = this.var_1654[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Array();
            this.var_1654[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
