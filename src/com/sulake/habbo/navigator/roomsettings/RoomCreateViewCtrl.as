package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1070:TextFieldManager;
      
      private var var_41:Array;
      
      private var var_1069:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_574 = new Timer(100);
         this.var_574.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_41 = new Array();
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_50,104,"a"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_50,94,"b"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_50,36,"c"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_50,84,"d"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_50,80,"e"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_50,80,"f"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_50,416,"i"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_50,320,"j"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_50,448,"k"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_50,352,"l"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_50,384,"m"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_50,372,"n"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_60,80,"g"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_60,74,"h"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_60,416,"o"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_60,352,"p"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_60,304,"q"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_60,336,"r"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_60,748,"u"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_60,438,"v"));
      ...
      public function dispose() : void
      {
         if(this.var_574)
         {
            this.var_574.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_574.reset();
            this.var_574 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1069.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1688 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1688 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_171 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_54 = IItemListWindow(this.var_171.findChildByName("item_list"));
         ...
         var _loc3_:IWindow = this.var_171.findChildByTag("close");
         this.addMouseClickListener(_loc3_,this.onCancelButtonClick);
         this.var_1070 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_171.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_171.desktop,this.var_171.width,this.var_171.height);
         this.var_171.x = _loc4_.x;
         this.var_171.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_1070.goBackToInitialState();
         this.var_1070.input.textBackgroundColor = 4294967295;
         this.var_1069 = this.var_41[0];
         this.refreshRoomThumbnails();
      ...
      {
         return Boolean(this.var_1070.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_171.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_171.findChildByName("back_button"));
      }
      ...
      {
         var _loc2_:String = this.var_1070.getText();
         var _loc3_:String = "model_" + this.var_1069.name;
