package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomEntryManager implements IDisposable
   {
      ...
      private static const const_1240:int = 267;
      
      private static const const_1239:int = 65;
      
      private static const const_1238:int = -70;
      ...
      private var var_2155:PublicRoomThumbs;
      
      public function OfficialRoomEntryManager(param1:HabboNavigator)
      {
         this.var_2155 = new PublicRoomThumbs();
         super();
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_632 || param2.type == OfficialRoomEntryData.const_885))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1239) : int(const_1240);
      ...
      {
         var _loc4_:String = this.var_2155.resolveRoomImageName(param2);
         ...
         param3.x = !!param2.showDetails ? int(const_1238) : 0;
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         if(_loc2_.guestRoomData != null)
         {
            ...
            if(_loc2_.guestRoomData.doorMode == RoomSettingsFlatInfo.const_109)
            {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_264,Tabs.const_393,_loc2_.tag);
         }
