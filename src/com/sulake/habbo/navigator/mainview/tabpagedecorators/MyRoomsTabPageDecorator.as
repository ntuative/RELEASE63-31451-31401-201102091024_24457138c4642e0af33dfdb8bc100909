package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_2793:IWindowContainer;
      
      private var var_487:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_487 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            this.var_487.procedure = this.onChangeSubNavi;
            this.prepareSubNavi();
         }
         _loc3_.visible = true;
      }
      ...
      {
         var _loc1_:int = this.var_487 == null ? 0 : int(this.var_487.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         this._navigator.mainViewCtrl.startSearch(Tabs.const_298,this.getSearchTypeForIndex(_loc1_));
      }
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_696;
         }
         if(param1 == 2)
         {
            return Tabs.const_785;
         }
         if(param1 == 3)
         {
         ...
         if(param1 == 4)
         {
            return Tabs.const_638;
         }
         return Tabs.const_254;
      }
   }
}
