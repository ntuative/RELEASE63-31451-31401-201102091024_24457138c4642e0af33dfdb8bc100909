package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_691:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_390 != null)
         {
            ...
            {
               _loc2_ = this.var_390.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_288 != null)
         {
            ...
            {
               _loc2_ = this.var_288.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         for each(_loc3_ in this.var_1049)
         {
            if(_loc3_ != null)
            {
               _loc3_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_724,RoomWidgetChatSelectAvatarMessage.const_764];
      }
            ...
            case RoomWidgetChatMessage.const_724:
               if(this._container != null && this._container.roomSession != null)
               {
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     {
                        case RoomWidgetChatMessage.const_131:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_764:
      ...
      {
         return [RoomSessionChatEvent.const_172];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_172:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_288.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_390.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_563.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_563.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_226)
                                    {
                                       this.var_288.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
                                       this.var_390.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1050 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1050);
            }
            if(this.var_691 == null)
            {
               ...
               this.var_467.y = 0;
               this.var_467.z = 0;
               this.var_691 = _loc4_.getScreenPoint(this.var_467);
               this.var_1050 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_467.x = 0;
            this.var_467.y = 0;
            this.var_467.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_467);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_691.x || _loc8_.y != this.var_691.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_691,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_288)
         {
            _loc2_ = this.var_288.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1049.push(_loc2_);
            }
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_390)
         {
            _loc2_ = this.var_390.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1049.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_563.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1625.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1625.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_288)
            {
               this.var_288.add(_loc3_,param2);
            }
         }
      }
   }
