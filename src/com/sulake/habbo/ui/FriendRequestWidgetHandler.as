package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_884);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_788);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_816);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_884:
            ...
            case RoomWidgetFriendRequestMessage.const_788:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_816:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_133);
         _loc1_.push(FriendRequestEvent.const_44);
         _loc1_.push(FriendRequestEvent.const_300);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_133:
            ...
            case FriendRequestEvent.const_300:
