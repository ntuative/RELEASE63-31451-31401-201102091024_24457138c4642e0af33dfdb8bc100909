package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_999:IHabboHelp;
      ...
      {
         this.var_1249 = RoomDesktop.const_541;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_610.release(new IIDHabboSoundManager());
            this.var_610 = null;
         }
         ...
         {
            this.var_999.release(new IIDHabboHelp());
            this.var_999 = null;
         }
         ...
         {
            this.var_806.release(new IIDHabboModeration());
            this.var_806 = null;
         }
         ...
         if(this.var_997)
         {
            this.var_997.release(new IIDHabboUserDefinedRoomEvents());
            this.var_997 = null;
         }
         this.var_1504 = null;
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_278.events.addEventListener(AdEvent.const_475,this.adEventHandler);
            this.var_278.events.addEventListener(AdEvent.const_421,this.adEventHandler);
            this.var_278.events.addEventListener(AdEvent.const_539,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_999 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_806 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_806);
      }
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_610 = param2 as IHabboSoundManager;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            this.var_15.events.addEventListener(RoomSessionEvent.const_211,this.roomSessionStateEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_172,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_554,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionUserBadgesEvent.const_65,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionUserGivableBadgesEvent.const_65,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPresentEvent.const_289,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_459,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_544,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1049,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_655,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_840,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_189,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_857,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_858,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_443,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionFriendRequestEvent.const_133,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionUserNotificationEvent.const_108,this.roomSessionEventHandler);
         }
      }
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionEvent.const_211:
            ...
            case RoomSessionEvent.const_97:
               if(param1.session != null)
               {
                  ...
                  this.var_167.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.ZOOM));
                  this.var_167.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.MEMENU));
                  this.var_167.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_857:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_858:
      ...
      {
         this.var_997 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_618,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_473,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_271,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_887,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_240,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_806,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_559,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_512 || param1.type == RoomEngineEvent.const_473)
         {
            ...
            case RoomEngineEvent.const_662:
               ...
               if(this._roomEngine != null)
               {
                  ...
                  if(!this._roomEngine.isPublicRoomWorldType(this._roomEngine.getWorldType(param1.roomId,param1.roomCategory)))
                  {
                     ...
                     _loc7_.iconState = "2";
                     this.var_167.events.dispatchEvent(_loc7_);
                  }
                  else
                  {
                     _loc5_ = true;
               ...
               if(this.var_1249 != RoomDesktop.const_541)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_277,this.var_1249);
               }
               if(this.var_278 != null)
               {
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.createWidget(RoomWidgetEnum.const_754);
         _loc3_.init();
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != RoomDesktop.const_541)
            {
               this.var_1249 = _loc3_;
            }
            _loc2_.dispose();
         }
      }
