package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_627,RoomWidgetViralFurniMessage.const_725,RoomWidgetViralFurniMessage.const_153];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_627:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_450);
                     _loc8_ = "+";
               ...
               break;
            case RoomWidgetViralFurniMessage.const_725:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_488,RoomSessionViralFurniStatusEvent.const_551];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_488:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_674);
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_551:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
