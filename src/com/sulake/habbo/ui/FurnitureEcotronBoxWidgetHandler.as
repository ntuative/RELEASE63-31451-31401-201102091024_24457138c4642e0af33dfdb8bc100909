package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_654,RoomWidgetEcotronBoxOpenMessage.const_736,RoomWidgetEcotronBoxOpenedMessage.const_1392];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_654:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_736:
