   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_320,this.onFigureUpdate);
            }
            if(this._inventory != null)
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_648,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_658,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_167 != null)
            {
               this.var_167.events.removeEventListener(HabboToolbarEvent.const_66,this.onHabboToolbarEvent);
               this.var_167.events.removeEventListener(HabboToolbarEvent.const_39,this.onHabboToolbarEvent);
            }
            ...
            if(this._container.habboHelp != null)
            {
               ...
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_119,this.onHelpTutorialEvent);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_320,this.onFigureUpdate);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_648,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_658,this.onHabboClubSubscriptionChanged);
         }
         this.var_167 = this._container.toolbar;
         if(this.var_167 != null)
         {
         ...
         if(this._container.habboHelp != null)
         {
            ...
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_119,this.onHelpTutorialEvent);
         }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1288)
            {
               ...
               this.var_1584 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1584;
            }
         }
         if(this.var_167 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1084,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
               _loc5_.bitmapData = _loc1_;
            }
            this.var_167.events.dispatchEvent(_loc5_);
         }
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetGetEffectsMessage.const_651);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_751);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_721);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_787);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_727);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_368);
         _loc1_.push(RoomWidgetStopEffectMessage.const_814);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1641);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1002);
         _loc1_.push(RoomWidgetToolbarMessage.const_864);
         _loc1_.push(RoomWidgetToolbarMessage.const_716);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_369);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1500);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1108);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_802);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_644);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_860);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1545);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_763);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_803);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_772);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_398);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetDanceMessage.const_693:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_651:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_751:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_721:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_368:
               ...
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1187)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_185,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_727:
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_977:
                        this._catalog.openCatalogPage(CatalogPageName.const_1377,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1122:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_307);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1487:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_83);
                        break;
            ...
            case RoomWidgetStopEffectMessage.const_814:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1002:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_802:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_864:
               ...
               if(this.var_167)
               {
                  this.var_167.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
            ...
            case RoomWidgetToolbarMessage.const_716:
               ...
               if(this.var_167 && this.var_167.events)
               {
                  this.var_167.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_571,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_369:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_525));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_860:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_400,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_763:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_400,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_803:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_400,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_772:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_561));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_398:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_669));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_719));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_119:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_119));
               break;
