package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_167:IHabboToolbar = null;
      ...
      private var var_999:IHabboHelp = null;
      ...
      private var var_610:IHabboSoundManager;
      
      private var _habboTracking:IHabboTracking;
      
      private var var_997:IHabboUserDefinedRoomEvents;
      ...
      private var var_188:DesktopLayoutManager;
      
      private var var_1508:Boolean = true;
      
      private var var_1509:Boolean = true;
      
      private var var_664:Array;
      
      private var var_201:IToolTipWindow;
      
      private var var_2038:uint = 16777215;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         this.var_188 = new DesktopLayoutManager();
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_371,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_419,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_671,this.onRoomContentLoaded);
         }
      }
      ...
      {
         this.var_167 = param1;
         this.var_167.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,this.onToolbarRepositionEvent);
         this.var_167.events.addEventListener(HabboToolbarEvent.const_39,this.onHabboToolbarEvent);
      }
      
      public function set layout(param1:XML) : void
      {
         this.var_188.setLayout(param1,this._windowManager);
         if(this.var_167 != null)
         {
            this.var_188.toolbarSize = this.var_167.size;
            this.var_188.toolbarOrientation = this.var_167.orientation;
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_371,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_419,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_671,this.onRoomContentLoaded);
         }
         ...
         {
            this.var_167.events.removeEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,this.onToolbarRepositionEvent);
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_31 != null)
         {
            this.var_664 = this._roomEngine.loadRoomResources(this.var_31.roomResources);
            if(this.var_664.length > 0)
            {
               this.var_1509 = false;
               this.processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_100));
            }
         }
         if(this.var_278 != null && this.var_31.state == RoomSessionEvent.const_211)
         {
            this.var_1508 = !this.var_278.showInterstitial();
         }
      ...
      {
         if(this.var_664 == null || this.var_664.length == 0)
         {
            return;
         }
         var _loc2_:int = this.var_664.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            this.var_664.splice(_loc2_,1);
         }
         if(this.var_664.length == 0)
         {
            this.var_1509 = true;
      ...
      public function createWidget(param1:String) : void
      {
         ...
         this.var_188.addWidgetWindow(_loc2_.mainWindow);
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               {
                  _loc6_ = this.var_665.getValue(_loc9_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_665.add(_loc9_,_loc6_);
                  }
                  else
                  {
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc6_ = this.var_666.getValue(_loc10_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_666.add(_loc10_,_loc6_);
                  }
                  _loc6_.push(_loc3_);
               }
            }
         ...
         param1 = "null";
         var _loc4_:RoomWidgetRoomViewUpdateEvent = new RoomWidgetRoomViewUpdateEvent(param1,this.var_188.roomViewRect);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         var _loc2_:Array = this.var_666.getValue(param1.type);
         if(_loc2_ != null)
         {
            for each(_loc3_ in _loc2_)
            {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_859:
               ...
               if(this.var_806 != null && _loc3_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_USER)
               {
                  ...
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_374)
                  {
                     this.var_806.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_271:
               switch(_loc3_)
               {
               ...
               break;
            case RoomEngineObjectEvent.const_887:
               switch(_loc3_)
               {
                  case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
                  case RoomObjectCategoryEnum.const_27:
            ...
            case RoomEngineObjectEvent.const_431:
               ...
               break;
            case RoomEngineObjectEvent.const_806:
               if(!this.var_31.isRoomController && !this.var_376.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_559:
            ...
            case RoomEngineObjectEvent.const_124:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_883,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
         }
         if(_loc4_ != null)
         {
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_473:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_117,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineEvent.const_512:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_1147,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc21_:* = null;
         var _loc2_:Rectangle = this.var_188.roomViewRect;
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_611);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_731);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_854);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_828);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_288,this.canvasMouseHandler);
         ...
         this.var_188.addRoomView(_loc9_);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2038);
      ...
      {
         var _loc3_:IWindowContainer = this.var_188.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function getRoomViewRect() : Rectangle
      {
         ...
         return this.var_188.roomViewRect;
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this._roomEngine.modifyRoomCanvas(this.var_31.roomId,this.var_31.roomCategory,this.var_279[0],_loc2_.width,_loc2_.height);
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.var_188.toolbarOrientation = param1.orientation;
         }
      }
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1510) / 1000);
         ...
         if(param1.iconId == HabboToolbarIconEnum.ZOOM)
         {
            if(this.var_31 != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  {
                     _loc3_.iconState = "2";
                     this.var_167.events.dispatchEvent(_loc3_);
                  }
                  else
                  {
                     _loc3_.iconState = "0";
      ...
      {
         if(this.var_15 != null && this.var_31 != null && this.var_1508 && this.var_1509)
         {
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_502:
               ...
               this.var_201 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_347,WindowStyle.const_623,WindowParam.const_95) as IToolTipWindow;
               this.var_201.setParamFlag(WindowParam.const_30,false);
