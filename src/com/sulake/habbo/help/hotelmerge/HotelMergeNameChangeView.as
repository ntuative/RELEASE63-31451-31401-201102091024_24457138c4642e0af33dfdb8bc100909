package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_651)
         {
            this.var_651 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_651)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_650)
         {
            this.var_650 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_650)
            {
               return;
            }
