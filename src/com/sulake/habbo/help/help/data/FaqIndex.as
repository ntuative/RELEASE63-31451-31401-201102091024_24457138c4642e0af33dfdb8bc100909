package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_656:FaqCategory;
      
      private var var_655:FaqCategory;
      ...
      {
         super();
         this.var_657 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_656 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_655 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         if(this.var_656.hasItem(param1))
         {
            this.var_656.getItem(param1).answerText = param2;
         }
         if(this.var_655.hasItem(param1))
         {
            this.var_655.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_656.hasItem(param1))
         {
            return this.var_656.getItem(param1);
         }
         if(this.var_655.hasItem(param1))
         {
            return this.var_655.getItem(param1);
         }
         var _loc2_:int = 0;
