package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1488:uint = 11129827;
      ...
      private var var_986:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1489 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_651)
         {
            this.var_651 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_651)
            {
               return;
            }
            this._window.content.addChild(this.var_651);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_650)
         {
            this.var_650 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_650)
            {
               return;
            }
            this._window.content.addChild(this.var_650);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_650.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_439;
         }
         this.showView(this.var_650);
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_785:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_972:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_973 || param1 == ChangeUserNameResultMessageEvent.var_972)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_986 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_986.render(param3,_loc5_);
         var _loc7_:int = 0;
