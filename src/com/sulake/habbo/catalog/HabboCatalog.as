package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_354:CatalogViewer;
      
      private var var_353:ICatalogNavigator;
      
      private var var_98:Purse;
      
      private var var_87:RecyclerLogic;
      
      private var var_131:IMarketPlace;
      ...
      private var var_2609:GiftWrappingConfiguration;
      
      private var var_1159:ClubGiftController;
      
      private var var_503:ClubBuyController;
      ...
      {
         var _loc4_:* = null;
         if(param1.priceInCredits > 0 && param1.priceInCredits > this.var_98.credits)
         {
            this.showNotEnoughCreditsAlert();
            return;
         }
         if(param1.priceInActivityPoints > 0 && param1.priceInActivityPoints > this.var_98.getActivityPointsForType(param1.activityPointType))
         {
         ...
         if(param1 is Offer)
         {
            if(this.var_219 == null)
            {
               this.var_219 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc4_ = [];
            ...
            this.var_219.showOffer(this,param1,param2,param3,_loc4_);
         ...
         {
            this.var_503.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_353.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      {
         return this.var_376.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_376.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_80)
         {
            _loc3_ = this.var_376.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.creditbalance","balance",String(this.var_98.credits));
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_98.getActivityPointsForType(Purse.const_181)));
         var _loc1_:int = 0;
         if(!this.var_98.hasClubLeft)
         {
         ...
         else
         {
            ...
            this._localization.registerParameter(_loc2_,"days",String(this.var_98.clubDays));
            this._localization.registerParameter(_loc2_,"months",String(this.var_98.clubPeriods));
         }
      ...
      {
         this.var_167.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_116,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_690)
         {
            if(!this.var_376.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         if(this.var_167 != null && _loc2_)
         {
            this.var_167.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_354.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_353 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_354 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_354.habboCatalog = this;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_85:
               this.var_1843 = param1.session.isPrivateRoom;
               if(this.var_87 != null)
               {
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_131 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1159 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_503 == null)
         {
            this.var_503 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_353.buildCatalogIndex(_loc2_);
         if(this.var_758 && this.var_758 != "")
         {
            this.var_353.openPage(this.var_758);
            this.var_758 = "";
            this.var_942 = -1;
         }
         else if(this.var_942 > -1)
         {
            this.var_353.openPageById(this.var_942,this.var_1842);
            this.var_942 = -1;
            this.var_1842 = -1;
            this.var_758 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_354.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_354 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_354.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.var_98.credits = _loc3_.balance;
         this.updatePurse();
         if(!this.var_2610 && this.var_610 != null)
         {
            this.var_610.playSound(HabboSoundTypesEnum.const_1077);
         }
         this.var_2610 = false;
         if(this.var_302 != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_64,this.var_98.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_98.activityPoints[_loc2_.type] = _loc2_.amount;
         this.updatePurse();
         if(!this.var_2611 && this.var_610 != null)
         {
            this.var_610.playSound(HabboSoundTypesEnum.const_1017);
         }
         this.var_2611 = false;
         if(this.var_302 != null)
         {
         ...
         if(_loc2_.type == Purse.const_181)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_104,_loc2_.amount));
         }
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         this.var_98.activityPoints = _loc2_.points;
         this.updatePurse();
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_104,_loc2_.points["null"]));
         }
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_98.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         this.var_98.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         this.var_98.isVIP = _loc2_.isVIP;
         this.var_98.pastClubDays = _loc2_.pastClubDays;
         this.var_98.pastVipDays = _loc2_.pastVipDays;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1159.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_354.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_131 != null)
         {
            this.var_131.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_131 != null)
         {
            this.var_131.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_131 != null)
         {
            this.var_131.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2609 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_131.averagePricePeriod = _loc2_.averagePricePeriod;
      }
