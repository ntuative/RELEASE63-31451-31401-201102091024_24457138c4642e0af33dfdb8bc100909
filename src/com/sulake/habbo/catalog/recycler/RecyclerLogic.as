package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_913:int = 0;
      ...
      {
         return this.var_561 != const_913;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1624 != RecyclerStatusMessageEvent.const_988;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_561 == const_407;
      }
      ...
      {
         this.var_561 = const_912;
         this.var_109 = new Array(const_187);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1622:
               this.var_561 = const_407;
               if(this._view == null)
               {
                  return;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_988:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1165:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1436:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_109.length > 0)
         {
            oldObjectData = this.var_109[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_187)
            {
               oldObjectData = this.var_109[newSlotId];
         ...
         this.var_109[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.method_2();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(this.var_109[param1] == null)
         {
            return;
         }
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_109[param1].id))
         {
            return;
         }
         this.var_109[param1] = null;
         this.method_2();
         this.updateRecyclerButton();
      }
      ...
      public function executeRecycler() : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_109.length)
         {
            _loc3_ = this.var_109[_loc2_];
            if(_loc3_ == null)
            {
               return;
            }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_109.length < const_187)
         {
            return false;
         }
         var _loc1_:int = 0;
