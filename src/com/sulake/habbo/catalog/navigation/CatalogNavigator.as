package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2803:String = "magic.credits";
      
      private var var_2773:String = "magic.pixels";
      
      private var var_2774:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2773);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2774,true);
      }
