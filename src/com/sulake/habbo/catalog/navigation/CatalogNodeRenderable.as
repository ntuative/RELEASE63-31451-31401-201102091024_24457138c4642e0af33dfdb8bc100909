package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1312:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1412:XML;
      
      private static var var_1413:XML;
       
      
      private var var_1810:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1412 == null)
         {
            ...
            var_1412 = _loc4_.content as XML;
         }
         if(var_1413 == null)
         {
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1810 == 4294967295)
            {
               this.var_1810 = _loc1_.color;
            }
            _loc1_.color = const_1312;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1568;
            }
         }
      }
      ...
      {
         this.var_54 = navigator.catalog.windowManager.buildFromXML(var_1413) as IItemListWindow;
         if(this.var_54 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1412) as IWindowContainer;
         }
         else
         {
