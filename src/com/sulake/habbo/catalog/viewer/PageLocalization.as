package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_1267:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      
      private static const const_1268:Array = ["ctlg_header_img","ctlg_teaserimg_1","ctlg_special_img","ctlg_teaserimg_2","ctlg_teaserimg_3"];
      ...
      private static const const_164:Dictionary = new Dictionary();
      ...
      {
         const_164["frontpage3"] = ["ctlg_txt3","ctlg_txt7"];
         const_164["info_pixels"] = ["ctlg_text_5","ctlg_text_7"];
         const_164["info_credits"] = ["ctlg_text_5","ctlg_text_7"];
         const_164["collectibles"] = ["ctlg_collectibles_link"];
         const_164["club1"] = ["ctlg_text_5"];
         const_164["club_buy"] = ["club_link"];
      }
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < this.var_701.length)
         {
            _loc2_ = String(this.var_701[param1]).replace("#","0x");
