package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1041:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1041.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         if(this.var_1040 != null)
         {
            this.var_1040.removeEventListener(WindowKeyboardEvent.const_182,this.windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         this.var_1041 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1041 != null)
         {
            this.var_1041.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1040 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1040 != null)
         {
            this.var_1040.addEventListener(WindowKeyboardEvent.const_182,this.windowKeyEventProcessor);
         }
      }
