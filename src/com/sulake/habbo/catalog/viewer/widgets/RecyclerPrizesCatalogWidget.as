package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1205:PrizeViewer;
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         this.var_1205 = new PrizeViewer();
         this.var_778 = this.recycler.getPrizeTable();
         ...
         if(this.var_778.length > 0 && this.var_778[0].prizes.length > 0)
         {
            this.select(this.var_778[0].prizes[0] as IGridItem);
         }
      }
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            this.createLevelItem(this.var_778[_loc2_]);
            _loc2_++;
         }
      }
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         this.var_1205.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
