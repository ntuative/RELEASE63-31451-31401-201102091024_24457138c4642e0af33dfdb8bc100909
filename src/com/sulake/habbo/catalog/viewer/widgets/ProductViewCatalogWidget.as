package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1354:IScrollbarWindow;
      ...
      {
         this.var_884 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1091 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_84 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1739 = new Point(this.var_84.x,this.var_84.y);
         this.var_482 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1354 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1740 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_884.text = _loc4_;
         this.var_1091.text = _loc5_;
         this.var_884.height = this.var_884.textHeight + 5;
         this.var_1091.y = this.var_884.y + this.var_884.height;
         this.var_1091.height = Math.max(130,this.var_1091.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_423:
                  _loc6_ = this.var_1740.clone();
                  if(this.var_482 != null)
                  {
                     this.var_482.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_482,this.var_1354,this.var_1915);
                     this.var_482.scrollV = 0;
                  }
                  break;
               case Offer.const_493:
                     ...
                     case ProductTypeEnum.const_237:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_291,AvatarAction.const_464);
                              _loc16_.appendAction(AvatarAction.const_315,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2455)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2455 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_84 != null && true)
         {
            ...
            this.var_84.x = this.var_1739.x;
            this.var_84.y = this.var_1739.y;
            if(param3 != null)
            {
