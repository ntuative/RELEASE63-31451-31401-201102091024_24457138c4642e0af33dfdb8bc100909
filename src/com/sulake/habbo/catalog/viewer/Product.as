package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1659:IProductData;
      ...
      {
         super();
         this.var_1660 = param1.productType;
         this.var_1658 = param1.furniClassId;
         this.var_1324 = param1.extraParam;
         this.var_1325 = param1.productCount;
         this.var_1657 = param1.expiration;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(this.productType)
         {
            ...
            case ProductTypeEnum.const_80:
               _loc6_ = _loc4_.getWallItemIcon(this.productClassId,param2,this.var_1324);
               break;
