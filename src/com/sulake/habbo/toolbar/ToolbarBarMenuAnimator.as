package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1241:Number = 25;
      
      private static const const_1303:Number = 90;
      
      private static const const_908:int = 50;
      
      private static const const_1242:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1282:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_547 = new Object();
         this.var_549 = new Array();
         this.var_548 = new Array();
         super();
         this._windowManager = param1;
         this.var_1282 = param2;
         this.var_680 = new Timer(const_1241);
         this.var_680.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_322[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_908 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_908 || param1.desktop.height - param1.y < const_1242;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1282.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_322.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1282.getIconLoc(param1.iconId);
      ...
      {
         return this.var_549[this.var_548.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_548[this.var_549.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_548.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_548.splice(_loc3_,1);
            this.var_549.splice(_loc3_,1);
         }
         this.var_549.push(param1.name);
         this.var_548.push(param2);
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_547[_loc3_] == null)
            {
               this.var_547[_loc3_] = new Array();
            }
            if(this.var_547[_loc3_].indexOf(param1) < 0)
            {
               this.var_547[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         if(this.var_322.indexOf(param1) > -1)
         {
            if(const_196)
            {
            ...
            else
            {
               ...
               this.var_322.splice(this.var_322.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         while(_loc2_ < this.var_549.length)
         {
            ...
            {
               _loc3_ = this.var_548[_loc2_];
               if(this.var_547[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_547[_loc3_].length)
                  {
                     this.repositionWindow(this.var_547[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_322.length)
         {
            _loc2_ = this._itemList[this.var_322[_loc7_]];
            if(_loc2_.active)
            {
