package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      private var var_2763:Number;
      
      private var var_2762:Number;
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_1387 = param1.loop;
         if(param1.background != null)
         {
            this.var_904 = this.getBitmapDataFromAsset(param1.background,param2);
         }
      ...
      {
         if(this.var_1387 == true || this.var_905 == 0)
         {
      ...
      {
         return this.var_1387 == false && this.var_905 == 1 && this.var_1791 != this._state;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_904.width),Math.max(param2.height,this.var_904.height));
            _loc3_.copyPixels(this.var_904,this.var_904.rect,new Point(0,0));
