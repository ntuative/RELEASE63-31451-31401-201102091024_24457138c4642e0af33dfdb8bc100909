package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1229:int = 10;
      
      private static const const_899:int = 100;
      
      private static const const_1228:int = 20;
       
      
      private var var_124:HabboMessenger;
      
      private var var_2076:IScrollbarWindow;
      
      private var var_1522:IContainerButtonWindow;
      
      private var var_54:IItemListWindow;
      
      private var var_444:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_124 = param1;
         this.var_1522 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_54 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2076 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_899 + const_1228)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1229;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_444 == null || _loc1_.id != this.var_444.id)
         {
            this.var_444 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_444.followingAllowed)
         {
            this.var_1522.enable();
         }
         else
         {
            this.var_1522.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_54.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_444.messages.length - const_899);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_444.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_444.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_691 || param3.type == Message.const_615 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_444.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_124.send(new FollowFriendMessageComposer(this.var_444.id));
      }
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_965)
         {
            return 4294927974;
         }
         if(param1 == Message.const_838)
         {
            return 4293454056;
         }
         if(param1 == Message.const_862)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1142)
         {
            return 4288269465;
         }
         return 4291611852;
