package com.sulake.habbo.session.handler
{
   ...
   public class VoteHandler extends BaseHandler
   {
      ...
      public function VoteHandler(param1:IConnection, param2:IRoomHandlerListener)
      {
         ...
         param1.addMessageEvent(new VoteQuestionMessageEvent(this.method_7));
         param1.addMessageEvent(new VoteResultMessageEvent(this.onVoteResultEvent));
      }
      
      private function method_7(param1:VoteQuestionMessageEvent) : void
      {
         var _loc4_:* = null;
         if(!param1)
         {
         ...
         _loc4_ = new RoomSessionVoteEvent(RoomSessionVoteEvent.const_137,_loc2_,_loc3_.question,_loc3_.choices);
      ...
      private function onVoteResultEvent(param1:VoteResultMessageEvent) : void
      {
         ...
         _loc4_ = new RoomSessionVoteEvent(RoomSessionVoteEvent.const_144,_loc2_,_loc3_.question,_loc3_.choices,_loc3_.votes,_loc3_.totalVotes);
         listener.events.dispatchEvent(_loc4_);
      }
   }
}
