   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_225)
         {
            ...
            {
               _loc1_ = this.var_225.getKey(0) as String;
               _loc2_ = this.var_225.remove(_loc1_) as RoomSession;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_73)
         {
            ...
            {
               _loc4_ = this.var_73[_loc3_] as IDisposable;
               if(_loc4_)
               {
                  _loc4_.dispose();
               }
      ...
      private function createHandlers() : void
      {
         ...
         this.var_73.push(new RoomSessionHandler(this._connection,this));
         this.var_73.push(new RoomChatHandler(this._connection,this));
         this.var_73.push(new RoomUsersHandler(this._connection,this));
         this.var_73.push(new RoomPermissionsHandler(this._connection,this));
         this.var_73.push(new AvatarEffectsHandler(this._connection,this));
         this.var_73.push(new RoomDataHandler(this._connection,this));
         this.var_73.push(new PresentHandler(this._connection,this));
         this.var_73.push(new PlaceObjectErrorHandler(this._connection,this));
         this.var_73.push(new TeleportErrorHandler(this._connection,this));
         this.var_73.push(new GenericErrorHandler(this._connection,this));
         this.var_73.push(new PollHandler(this._connection,this));
         this.var_73.push(new VoteHandler(this._connection,this));
         this.var_73.push(new LidoHandler(this._connection,this));
         this.var_73.push(new RoomDimmerPresetsHandler(this._connection,this));
         this.var_73.push(new ViralFurniHandler(this._connection,this));
         this.var_73.push(new UserNotificationHandler(this._connection,this));
         this.var_73.push(new PetPackageHandler(this._connection,this));
      }
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1921)
         {
            this.gotoRoom(this.var_2709,this.var_2711,this.var_1920);
            this.var_1921 = false;
            this.var_1920 = "";
         }
      }
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_211,_loc7_));
         return true;
      }
      ...
      public function sessionReinitialize(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc6_:RoomSession = this.var_225.remove(_loc5_) as RoomSession;
         if(_loc6_ != null)
         {
            param4 = param2;
            _loc6_.reset(param3,param4);
            _loc5_ = this.getRoomIdentifier(param3,param4);
            _loc7_ = this.var_225.remove(_loc5_);
            if(_loc7_ != null)
            {
            }
            this.var_225.add(_loc5_,_loc6_);
      ...
      public function getSession(param1:int, param2:int) : IRoomSession
      {
         ...
         return this.var_225.getValue(_loc3_) as IRoomSession;
      }
      
      public function disposeSession(param1:int, param2:int) : void
      {
         var _loc3_:String = this.getRoomIdentifier(param1,param2);
         var _loc4_:RoomSession = this.var_225.remove(_loc3_) as RoomSession;
         if(_loc4_ != null)
         {
      ...
      private function updateHandlers(param1:IRoomSession) : void
      {
         ...
         if(param1 != null && this.var_73 != null)
         {
            ...
            {
               _loc3_ = this.var_73[_loc2_] as BaseHandler;
               if(_loc3_ != null)
               {
