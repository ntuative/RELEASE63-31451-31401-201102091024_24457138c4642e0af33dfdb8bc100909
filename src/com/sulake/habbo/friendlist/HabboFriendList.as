package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_1022:IAvatarRenderManager;
      
      private var var_679:ISessionDataManager;
      
      private var var_2160:FriendListLookAndFeel;
      
      private var var_391:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1571:OpenedToWebPopup;
      
      private var var_2159:int;
      
      var var_94:FriendCategories;
      
      private var var_321:FriendRequests;
      
      private var var_1570:AvatarSearchResults;
      
      private var var_167:IHabboToolbar;
      
      private var var_848:IHabboNotifications;
      
      private var var_546:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2160 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_94 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1570 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_546.stop();
            this.var_546.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_546 = null;
         }
         ...
         if(this.var_1022)
         {
            this.var_1022.release(new IIDAvatarRenderManager());
            this.var_1022 = null;
         }
         if(this.var_848)
         {
            this.var_848.release(new IIDHabboNotifications());
            this.var_848 = null;
         }
         if(this.var_167)
         {
         ...
         if(this.var_679)
         {
            this.var_679.release(new IIDSessionDataManager());
            this.var_679 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1571 = new OpenedToWebPopup(this);
         }
         this.var_1571.show(x,y);
      }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_106,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(this.var_321.getCountOfOpenRequests() > 0 ? "2" : "0");
         this.var_167.events.dispatchEvent(_loc1_);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_270,HabboWindowStyle.const_40,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1022.createAvatarImage(param1,AvatarScaleType.const_88,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1022 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_167 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      {
         this.var_848 = param2 as IHabboNotifications;
      ...
      {
         this.var_679 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_321 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_94.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_94.addCategory(new FriendCategory(FriendCategory.const_975,this.getText("friendlist.friends")));
         this.var_94.addCategory(new FriendCategory(FriendCategory.const_403,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_94.addFriend(new Friend(_loc4_));
         }
         this.var_391 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_546)
         {
            this.var_546 = new Timer(120000);
            this.var_546.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_546.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_167.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_116,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_94.findCategory(FriendCategory.const_403);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_391.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_386));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_321.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_321.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_391.findTab(FriendListTab.const_92).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_321.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_391.findTab(FriendListTab.const_92);
      ...
      private function onAcceptBuddyResult(param1:IMessageEvent) : void
      {
         ...
         for each(_loc3_ in _loc2_.method_13)
         {
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1570.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_391.findTab(FriendListTab.const_92);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_679 || !this.var_321)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_679.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_321.vipLimit;
         }
         else if(this.var_679.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_321.clubLimit;
         }
         if(_loc2_ > this.var_321.limit)
         {
            this.var_321.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_157) as IBitmapWrapperWindow;
