package com.sulake.habbo.friendlist
{
   ...
   public class Util
   {
      ...
      public static function method_6(param1:String, param2:IWindow) : void
      {
         var _loc4_:int = 0;
         Logger.log(param1 + param2 + " (" + param2.width + ", " + param2.height + "), " + param2.getParamFlag(HabboWindowParam.const_61));
         ...
         if(_loc3_ != null)
         {
            ...
            {
               method_6(param1 + "-",_loc3_.getChildAt(_loc4_));
               _loc4_++;
            }
         }
      }
