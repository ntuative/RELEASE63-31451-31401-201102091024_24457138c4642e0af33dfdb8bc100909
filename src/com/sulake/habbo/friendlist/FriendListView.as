package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1705:String = "noconvinfo";
      
      private static const const_1704:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1465:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1465 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_854 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_249 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1465.prepare(this.var_854);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_990,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1005,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_756,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_832,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_756,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_832,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1466 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1466.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1902 == -1 ? 0 : int(this.var_17.height - this.var_1902);
         var _loc4_:int = this.var_1903 == -1 ? 0 : int(this.var_17.width - this.var_1903);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_249.y = Util.getLowestPoint(this.var_17.content);
         this.var_249.width = this._friendList.tabs.windowWidth;
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1078,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_756,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_990,false);
         ...
         this.var_1902 = this.var_17.height;
         this.var_1903 = this.var_17.width;
