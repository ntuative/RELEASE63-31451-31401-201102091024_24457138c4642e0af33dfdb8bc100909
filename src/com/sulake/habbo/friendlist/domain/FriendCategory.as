package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_389:int = 100;
      ...
      {
         if(this.var_955 >= this.getPageCount())
         {
            this.var_955 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_223.length / const_389);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_955 * const_389;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_955 + 1) * const_389,this.var_223.length);
      }
