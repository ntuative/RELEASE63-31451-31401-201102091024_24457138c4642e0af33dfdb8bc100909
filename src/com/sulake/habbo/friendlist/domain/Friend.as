package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1870:int = "F".charCodeAt(0);
      
      public static const const_1741:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_964 = param1.gender;
         this.var_736 = param1.online;
         this.var_1802 = param1.followingAllowed && param1.online;
         this.var_630 = param1.figure;
         this.var_1894 = param1.motto;
         this.var_1752 = param1.lastAccess;
         this.var_1460 = param1.categoryId;
         this.var_1753 = param1.realName;
