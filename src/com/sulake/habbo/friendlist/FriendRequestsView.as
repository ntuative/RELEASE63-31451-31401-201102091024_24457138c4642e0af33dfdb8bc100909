package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1661:String = "no_reqs_info";
      ...
      {
         this.var_1536 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1537 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1537.procedure = this.onDismissAllButtonClick;
         this.var_1536.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_158)
         {
         ...
         else if(param1.state == FriendRequest.const_340)
         {
         ...
         else if(param1.state == FriendRequest.const_1000)
         {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_340;
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_300,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_340 && _loc4_.state != FriendRequest.const_333)
            {
               _loc4_.state = FriendRequest.const_333;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_300,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_340 && _loc4_.state != FriendRequest.const_333)
            {
               ...
               _loc4_.state = FriendRequest.const_340;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1536,_loc1_);
         this.setEnabled(this.var_1537,_loc1_);
      }
